...
public class RenderBlocks
{
    ...
    public boolean renderBlockBed(Block par1Block, int par2, int par3, int par4)
    {
        ...
        if (Reflector.hasMethod(52))
        {
            var7 = Reflector.callInt(par1Block, 52, new Object[] {this.blockAccess, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4)});
        }

        if (Reflector.hasMethod(53))
        {
            var8 = Reflector.callBoolean(par1Block, 53, new Object[] {this.blockAccess, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4)});
        }
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            var10.setBrightness(this.field_83027_i <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 - 1, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 + 1, par4, 1))
        {
            var10.setBrightness(this.field_83024_j >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 + 1, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            var10.setBrightness(this.field_83025_k <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 - 1) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            var10.setBrightness(this.field_83022_l >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 + 1) : var28);
            var10.setColorOpaque_F(var20, var23, var26);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            var10.setBrightness(this.field_83021_g <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 - 1, par3, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            var10.setBrightness(this.field_83026_h >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 + 1, par3, par4) : var28);
            var10.setColorOpaque_F(var21, var24, var27);
    ...
    public void renderBottomFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        var37 = par2 + this.field_83021_g;
        double var39 = par2 + this.field_83026_h;
        double var41 = par4 + this.field_83027_i;
        double var43 = par6 + this.field_83025_k;
        double var45 = par6 + this.field_83022_l;
    ...
    public void renderTopFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        var37 = par2 + this.field_83021_g;
        double var39 = par2 + this.field_83026_h;
        double var41 = par4 + this.field_83024_j;
        double var43 = par6 + this.field_83025_k;
        double var45 = par6 + this.field_83022_l;
    ...
    public void renderEastFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        double var39 = par2 + this.field_83026_h;
        double var41 = par4 + this.field_83027_i;
        double var43 = par4 + this.field_83024_j;
        double var45 = par6 + this.field_83025_k;
    ...
    public void renderNorthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        var37 = par2 + this.field_83021_g;
        double var39 = par4 + this.field_83027_i;
        double var41 = par4 + this.field_83024_j;
        double var43 = par6 + this.field_83025_k;
        double var45 = par6 + this.field_83022_l;
    ...
    public static boolean renderItemIn3d(int par0)
    {
        switch (par0)
        {
            ...
            default:
                ...
                {
                    return Reflector.callBoolean(2, new Object[] {Integer.valueOf(par0)});
                }
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4)
    {
        ...
        switch (var5)
        {
            ...
            default:
                if (Reflector.hasClass(0))
                {
                    return Reflector.callBoolean(0, new Object[] {this, this.blockAccess, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4), par1Block, Integer.valueOf(var5)});
                }
