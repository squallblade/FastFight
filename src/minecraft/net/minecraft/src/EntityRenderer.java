...
public class EntityRenderer
{
    ...
    private void orientCamera(float par1)
    {
        ...
        if (var2.isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                {
                    Reflector.callVoid(11, new Object[] {this.mc, var2});
                }
    ...
    private void updateLightmap(float par1)
    {
        ...
        if (var2 != null)
        {
            ...
            for (int var3 = 0; var3 < 256; ++var3)
            {
                ...
                {
                    var14 = this.func_82830_a(this.mc.thePlayer, par1);
                    var15 = 1.0F / var11;
    ...
    public void updateCameraAndRender(float par1)
    {
        ...
        if (!var14 && this.mc.gameSettings.pauseOnLostFocus && (!this.mc.gameSettings.field_85185_A || !Mouse.isButtonDown(1)))
        {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            int var19 = func_78465_a(this.mc.gameSettings.limitFramerate);
    ...
    private void waitForServerThread()
    {
        ...
        else if (this.mc.getIntegratedServer() != null)
        {
            ...
            boolean var2 = var1.getServerListeningThread().func_71752_f();
    ...
    public void renderWorld(float par1, long par2)
    {
        ...
        for (int var13 = 0; var13 < 2; ++var13)
        {
            ...
            boolean var16 = Reflector.hasClass(1);
            EntityPlayer var18;
            ...
            if (this.debugViewDirection == 0)
            {
                ...
                if (this.mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !this.mc.gameSettings.hideGUI)
                {
                    ...
                    if (!var16 || !Reflector.callBoolean(10, new Object[] {var5, var18, this.mc.objectMouseOver, Integer.valueOf(0), var18.inventory.getCurrentItem(), Float.valueOf(par1)}))
                    {
    ...
    private void updateFogColor(float par1)
    {
        ...
        {
            var24 = this.func_82830_a(this.mc.thePlayer, par1);
