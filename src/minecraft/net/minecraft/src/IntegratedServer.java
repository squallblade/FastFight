...
public class IntegratedServer extends MinecraftServer
{
    ...
    protected void loadAllWorlds(String par1Str, String par2Str, long par3, WorldType par5WorldType, String par6Str)
    {
        ...
        if (Reflector.hasClass(17))
        {
            ...
            Integer[] var9 = (Integer[])((Integer[])Reflector.call(170, Reflector.NO_PARAMS));
            Integer[] var10 = var9;
            ...
            for (int var12 = 0; var12 < var11; ++var12)
            {
                ...
                if (Reflector.hasClass(20))
                {
                    Reflector.postForgeBusEvent(18, new Object[] {var14});
                }
            }
    ...
    protected boolean startServer() throws IOException
    {
        ...
        if (Reflector.hasClass(21))
        {
            Object var1 = Reflector.call(210, Reflector.NO_PARAMS);
            Reflector.callVoid(var1, 211, new Object[] {this});
        }
