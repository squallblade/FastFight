...
public class Config
{
    ...
    public static final String VERSION = "OptiFine_1.4.5_HD_U_D7";
    ...
    {
        return gameSettings == null ? false : (getAvailableProcessors() > 1 ? false : gameSettings.ofSmoothWorld);
    }
