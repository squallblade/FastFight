...
public class GuiMainMenu extends GuiScreen
{
    ...
    private void updateAnnounces(){
        String var3 = "";
        try{
            URL var4 = new URL("http://sam-serv.mtxserv.fr/annonce.txt");
            String var2;
    ...
    protected void actionPerformed(GuiButton par1GuiButton){
        ...
        if (par1GuiButton.id == 10){
            ...
            java.net.URI url;
            try{
                url = new java.net.URI("http://fastfight.net");
        ...
        if (par1GuiButton.id == 2){
        			this.mc.displayGuiScreen(new GuiConnecting(mc, "fastfight.net", 25565));
        }
...
//       this.drawRect(0, 0, this.width, this.height, 0xff);
         ...
         if ((double)this.updateCounter < 1.0E-4D){
             ...
             GL11.glPushMatrix();
             GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.mc.renderEngine.getTexture("/title/logo1.png"));
...
//        this.drawString(this.fontRenderer, "Moddé par:", 10, this.height - 32, 0x716dd6); //ajout
        this.drawString(this.fontRenderer, FontColors.YELLOW + "Made by Squallblade", 10, this.height - 22, 0x8a0f0f); //ajout
        this.drawString(this.fontRenderer, FontColors.DARK_AQUA + "FastFight Launcher Beta", this.width - this.fontRenderer.getStringWidth(FontColors.DARK_RED + "FastFight Launcher Beta") - 40, this.height - 15, 0x716dd6); //ajout
...
//        GL11.glPopMatrix();
        ...
        this.multi = new GuiButton(2, this.width -151 + this.X, 22, 150, 20, FontColors.DARK_RED + "FastFight");
