...
public class GuiMainMenu extends GuiScreen
{
    ...
    public GuiMainMenu(){
        ...
        this.announces = new String[] {"Bon jeu sur MineForWars !"};
    ...
    private void updateAnnounces(){
        String var3 = "";
        try{
            URL var4 = new URL("http://mineforwars.com/ficher-launcher/annonce.txt");
            String var2;
    ...
    protected void actionPerformed(GuiButton par1GuiButton){
        ...
        if (par1GuiButton.id == 6){
            ...
            java.net.URI url;
            try{
                url = new java.net.URI("http://mineforwars.com");
        ...
        if (par1GuiButton.id == 2){
        		this.mc.displayGuiScreen(new GuiConnecting(mc, "play.mineforwars.com", 25567));  
        	}	
...
//         System.out.println(this.width+"   "+this.height);
    ...
    public void drawScreen(int par1, int par2, float par3){
        ...
        this.drawString(this.fontRenderer, "\2474Squallblade", 10, this.height - 22, 0x8a0f0f); //ajout
        this.drawString(this.fontRenderer, "\2476MineForWars \24741.4.5", this.width - this.fontRenderer.getStringWidth("\2476MineForWars \24741.4.5") - 40, this.height - 15, 0x716dd6); //ajout
        ...
        this.multi = new GuiButton(2, this.width -151 + this.X, 22, 150, 20, "Jouer sur \2476MineForWars");
