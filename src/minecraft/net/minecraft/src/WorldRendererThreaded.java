...
public class WorldRendererThreaded extends WorldRenderer
{
    ...
    public void updateRenderer(IWrUpdateListener var1)
    {
        if (this.worldObj != null)
        {
            ...
            {
                Object var28 = Reflector.getFieldValue(30);
                Reflector.callVoid(var28, 30, Reflector.NO_PARAMS);
            ...
            if (!var11.extendedLevelsInChunkCache())
            {
                ...
                boolean var14 = Reflector.hasClass(1);
                ...
                for (int var16 = 0; var16 < 2; ++var16)
                {
                            ...
                            for (int var22 = var2; var22 < var5; ++var22)
                            {
                                ...
                                if (var23 > 0)
                                {
                                    if (!var19)
                                    {
                                        ...
                                        if (var14)
                                        {
                                            Reflector.callVoid(13, new Object[] {Integer.valueOf(var16)});
                                        }
                                    ...
                                    if (var14)
                                    {
                                        var26 = Reflector.callBoolean(var24, 54, new Object[] {Integer.valueOf(var16)});
                                    }
                                    ...
                                    if (var26)
                                    {
                                        if (var14)
                                        {
                                            Reflector.callVoid(15, new Object[] {var24, var12});
                                        }
                                        ...
                                        if (var14)
                                        {
                                            Reflector.callVoid(16, new Object[] {var24, var12});
                                        }
                                    }
                                }
                            }
                    ...
                    if (var19)
                    {
                        ...
                        if (var14)
                        {
                            Reflector.callVoid(14, new Object[] {Integer.valueOf(var16)});
                        }
