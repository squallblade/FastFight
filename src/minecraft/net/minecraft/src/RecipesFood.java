...
public class RecipesFood
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        par1CraftingManager.func_92103_a(new ItemStack(Item.cookie, 8), new Object[] {"#X#", 'X', new ItemStack(Item.dyePowder, 1, 3), '#', Item.wheat});
        par1CraftingManager.func_92103_a(new ItemStack(Block.melon), new Object[] {"MMM", "MMM", "MMM", 'M', Item.melon});
        par1CraftingManager.func_92103_a(new ItemStack(Item.melonSeeds), new Object[] {"M", 'M', Item.melon});
        par1CraftingManager.func_92103_a(new ItemStack(Item.pumpkinSeeds, 4), new Object[] {"M", 'M', Block.pumpkin});
