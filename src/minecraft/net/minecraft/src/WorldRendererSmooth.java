    ...
    public boolean updateRenderer(long var1)
    {
        ...
        else
        {
            ...
            if (!this.isUpdating)
            {
                ...
                {
                    Object var25 = Reflector.getFieldValue(30);
                    Reflector.callVoid(var25, 30, Reflector.NO_PARAMS);
                    Reflector.callVoid(40, Reflector.NO_PARAMS);
                }
            ...
            if (this.isUpdating || !var9.extendedLevelsInChunkCache())
            {
                ...
                boolean var13 = Reflector.hasClass(1);
                    ...
                    for (int var18 = var4; var18 < var7; ++var18)
                    {
                        if (this.isUpdating)
                        {
                            ...
                            if (var17)
                            {
                                ...
                                if (var13)
                                {
                                    Reflector.callVoid(13, new Object[] {Integer.valueOf(var14)});
                                }
                        ...
                        else if (var17 && var1 != 0L && System.nanoTime() - var1 > 0L && this.activeListIndex[var14] < 15)
                        {
                            if (var13)
                            {
                                Reflector.callVoid(14, new Object[] {Integer.valueOf(var14)});
                            }
                        ...
                        for (int var19 = var5; var19 < var8; ++var19)
                        {
                            for (int var20 = var26; var20 < var6; ++var20)
                            {
                                ...
                                if (var21 > 0)
                                {
                                    ...
                                    if (var13)
                                    {
                                        var24 = Reflector.callBoolean(var22, 54, new Object[] {Integer.valueOf(var14)});
                                    }
                                    ...
                                    if (var24)
                                    {
                                        if (var13)
                                        {
                                            Reflector.callVoid(15, new Object[] {var22, var10});
                                        }
                                        ...
                                        if (var13)
                                        {
                                            Reflector.callVoid(16, new Object[] {var22, var10});
                                        }
                                    }
                                }
                            }
