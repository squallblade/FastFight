...
public class RenderEngine
{
    ...
    public RenderEngine(TexturePackList par1TexturePackList, GameSettings par2GameSettings)
    {
        if (Config.isMultiTexture())
        {
            ...
            {
                Display.destroy();
                Display.create(new PixelFormat(0, 8, 0, var3));
            }
        ...
        Graphics var8 = this.missingTextureImage.getGraphics();
    ...
    public int getTexture(String par1Str)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                if (Reflector.hasClass(1))
                {
                    Reflector.callVoid(19, new Object[] {par1Str, var3});
                }
    ...
    public void setupTexture(BufferedImage par1BufferedImage, int par2)
    {
        ...
        {
            Reflector.callVoid(70, new Object[] {Integer.valueOf(par2), Integer.valueOf(var4), Integer.valueOf(var5), this.textureList});
        }
    ...
    public void registerTextureFX(TextureFX par1TextureFX)
    {
        ...
        {
            TextureHDFX var6 = (TextureHDFX)par1TextureFX;
            var6.setTexturePackBase(this.texturePack.getSelectedTexturePack());
            Dimension var7 = this.getTextureDimensions(var2);

            if (var7 != null)
            {
                var6.setTileWidth(var7.width / 16);
            }
        }
            ...
            if (!var5.getClass().getName().equals("ModTextureStatic") || !this.dynamicTexturesUpdated)
            {
                ...
                if (!var10 || this.imageData.limit() > 0)
                {
                    ...
                    if (this.imageData.limit() <= 0)
                    {
                        ...
                        if (Reflector.hasClass(7) && !Reflector.callBoolean(72, new Object[] {var5}) || var5.imageData == null)
                        {
                            continue;
                        }
    ...
    public void refreshTextures()
    {
        ...
        if (Reflector.hasClass(7))
        {
            Reflector.callVoid(73, new Object[] {this, var1, this.textureList});
        }
