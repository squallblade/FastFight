...
public class RenderGlobal implements IWorldAccess
{
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        if (this.occlusionEnabled && this.mc.gameSettings.advancedOpengl && !this.mc.gameSettings.anaglyph && par2 == 0)
        {
            ...
            for (int var46 = this.renderChunksWide / 2; var24 < this.sortedWorldRenderers.length; var20 += this.renderSortedRenderers(var28, var24, par2, par3))
            {
    ...
    private int renderSortedRenderers(int par1, int par2, int par3, double par4)
    {
        ...
        for (int var7 = par1; var7 < par2; ++var7)
        {
            ...
            if (!var8.skipRenderPass[par3] && var8.isInFrustum && (!this.occlusionEnabled || var8.isVisible))
            {
    ...
    {
        if (Reflector.hasMethod(140))
        {
            WorldProvider var2 = this.mc.theWorld.provider;
            Object var3 = Reflector.call(var2, 140, Reflector.NO_PARAMS);

            if (var3 != null)
            {
                Reflector.callVoid(var3, 150, new Object[] {Float.valueOf(par1), this.theWorld, this.mc});
                return;
            }
        }
    ...
    public void renderClouds(float par1)
    {
        ...
        {
            if (Reflector.hasMethod(141))
            {
                WorldProvider var2 = this.mc.theWorld.provider;
                Object var3 = Reflector.call(var2, 141, Reflector.NO_PARAMS);
            ...
            else
            {
                ...
                else
                {
                    ...
                    else if (par1Str.startsWith("tilecrack_"))
                    {
                        ...
                        var21 = (new EntityDiggingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Block.blocksList[var28], 0, var29)).func_90019_g(var29);
                    ...
                    if (var21 != null)
                    {
                        ...
                        {
                            Reflector.callVoid(this.mc.effectRenderer, 80, new Object[] {var21, var22});
                        }
                        else
                        {
    ...
    public void obtainEntitySkin(Entity par1Entity)
    {
        ...
        if (par1Entity.cloakUrl != null)
        {
            ...
            if (par1Entity instanceof EntityPlayer)
            {
                ...
                String var4 = "http://optifine.net/capes/" + StringUtils.stripControlCodes(var2.username) + ".png";
