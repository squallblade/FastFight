...
public class RecipesWeapons
{
    ...
    public void addRecipes(CraftingManager par1CraftingManager)
    {
        ...
        par1CraftingManager.func_92103_a(new ItemStack(Item.bow, 1), new Object[] {" #X", "# X", " #X", 'X', Item.silk, '#', Item.stick});
        par1CraftingManager.func_92103_a(new ItemStack(Item.arrow, 4), new Object[] {"X", "#", "Y", 'Y', Item.feather, 'X', Item.flint, '#', Item.stick});
    }
}
