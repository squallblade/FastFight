...
public class BlockStep2 extends BlockHalfSlab2
{
    /** The list of the types of step blocks. */
    public static final String[] blockStepTypes = new String[] {"obsidian"};

    public BlockStep2(int par1, boolean par2)
    {
    ...
    {
        int var3 = par2 & 1;
        return var3 == 0 ? Block.obsidian.blockIndexInTexture : 0;
    }
