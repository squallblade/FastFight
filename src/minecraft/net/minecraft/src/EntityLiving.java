...
public abstract class EntityLiving extends Entity
{
    ...
    {
        if (!Reflector.hasClass(9) || !Reflector.callBoolean(91, new Object[] {this}))
        {
            super.onUpdate();
    ...
    {
        if (Reflector.hasClass(9) && Reflector.callBoolean(92, new Object[] {this, par1DamageSource, Integer.valueOf(par2)}))
        {
            return false;
        }
    ...
    protected void damageEntity(DamageSource par1DamageSource, int par2)
    {
        if (!this.func_85032_ar())
        {
            if (Reflector.hasClass(9))
            {
                par2 = Reflector.callInt(93, new Object[] {this, par1DamageSource, Integer.valueOf(par2)});
    ...
    {
        if (!Reflector.hasClass(9) || !Reflector.callBoolean(94, new Object[] {this, par1DamageSource}))
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (Reflector.hasClass(9))
                {
                    ...
                    var4 = (List)Reflector.getFieldValue(this, 101);
                    Reflector.callVoid(var4, 110, Reflector.NO_PARAMS);
                }
                ...
                if (Reflector.hasClass(9))
                {
                    ...
                    if (!Reflector.callBoolean(95, new Object[] {this, par1DamageSource, var4, Integer.valueOf(var3), Boolean.valueOf(this.recentlyHit > 0), Integer.valueOf(var5)}))
                    {
    ...
    protected void fall(float par1)
    {
        if (Reflector.hasClass(9))
        {
            par1 = Reflector.callFloat(96, new Object[] {this, Float.valueOf(par1)});
    ...
    public boolean isOnLadder()
    {
        ...
        return Reflector.hasMethod(50) ? Reflector.callBoolean(98, new Object[] {Block.blocksList[var4], this.worldObj, Integer.valueOf(var1), Integer.valueOf(var2), Integer.valueOf(var3)}): var4 == Block.ladder.blockID || var4 == Block.vine.blockID;
    }
    ...
    public void curePotionEffects(ItemStack var1)
    {
        ...
        if (!this.worldObj.isRemote)
        {
            while (var2.hasNext())
            {
                ...
                if (Reflector.callBoolean(var4, 130, new Object[] {var1}))
                {
                    var2.remove();
