...
public class RandomMobs {
   ...
   public static void entityLoaded(Entity var0) {
      if(var0.field_70120_cr == null) {
         if(var0 instanceof EntityLiving) {
            if(!(var0 instanceof EntityPlayer)) {
               EntityLiving var1 = (EntityLiving)var0;
               WorldServer var2 = Config.getWorldServer();
               if(var2 == null) {
                  var1.field_70120_cr = "123" + var1.field_70157_k;
               } else {
                  Entity var3 = var2.func_73045_a(var0.field_70157_k);
                  if(var3 instanceof EntityLiving) {
                     EntityLiving var4 = (EntityLiving)var3;
                     int var5 = var4.persistentId;
                     var1.persistentId = var5;
                     var1.field_70120_cr = "" + var5;
                     var4.field_70120_cr = var1.field_70120_cr;
                  }
               }
            }
         }
      ...
      if(var1 == null) {
         ...
         if(var2 >= 48 && var2 <= 57) {
            ...
            if(var4 != null && var4.length > 0) {
               ...
               return Config.getMinecraft().field_71446_o.func_78341_b(var6);
            } else {
               return -1;
            }
         } else {
   ...
   private static String[] getTextureVariants(String var0) {
      RenderEngine var1 = Config.getMinecraft().field_71446_o;
      var1.func_78341_b(var0);
   ...
   private static int getCountTextureVariants(String var0, String var1, String var2) {
      RenderEngine var3 = Config.getMinecraft().field_71446_o;
      short var4 = 1000;
      ...
      for(int var5 = 2; var5 < var4; ++var5) {
         ...
         try {
            InputStream var7 = var3.field_78366_k.func_77292_e().func_77532_a(var6);
            if(var7 == null) {
               return var5 - 1;
            }
