...
public class ConnectedTextures {
   ...
   public static void update(RenderEngine var0) {
      ...
      if(blockProperties == null && terrainProperties == null && matchingCtmPng) {
         ...
         blockProperties[Block.field_71946_M.field_71990_ca] = new ConnectedProperties[1];
         blockProperties[Block.field_71946_M.field_71990_ca][0] = makeDefaultProperties("ctm", var0);
         blockProperties[Block.field_72093_an.field_71990_ca] = new ConnectedProperties[1];
         blockProperties[Block.field_72093_an.field_71990_ca][0] = makeDefaultProperties("horizontal", var0);
         terrainProperties = new ConnectedProperties[256][];
         terrainProperties[Block.field_71957_Q.field_72059_bZ] = new ConnectedProperties[1];
         terrainProperties[Block.field_71957_Q.field_72059_bZ][0] = makeDefaultProperties("top", var0);
      }
      ...
      while(var5 < var1) {
         ...
         while(true) {
            if(var7 < propSuffixes.length) {
               ...
               InputStream var10 = var2.field_78366_k.func_77292_e().func_77532_a(var9);
               if(var10 != null) {
                  try {
                     ...
                     if(var12.isValid(var9)) {
                        ...
                        var12.textureId = var2.func_78341_b(var12.source);
                        var6.add(var12);
                        var10.close();
                     }
   ...
   public static int getConnectedTexture(IBlockAccess var0, Block var1, int var2, int var3, int var4, int var5, int var6) {
      if(var0 == null) {
         ...
         int var7 = -1;
         if(terrainProperties != null && Tessellator.field_78398_a.defaultTexture && var6 >= 0 && var6 < terrainProperties.length) {
            ConnectedProperties[] var8 = terrainProperties[var6];
            if(var8 != null) {
               if(var7 < 0) {
                  var7 = var0.func_72805_g(var2, var3, var4);
               }
   ...
   private static boolean isNeighbour(ConnectedProperties var0, IBlockAccess var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = var1.func_72798_a(var2, var3, var4);
      if(var0.connect == 2) {
         Block var10 = Block.field_71973_m[var9];
         if(var10 == null) {
            return false;
         } else {
            int var11 = var10.func_71895_b(var1, var2, var3, var4, var6);
            return var11 == var7;
         }
      } else {
         return var9 == var5 && var1.func_72805_g(var2, var3, var4) == var8;
      }
   }
   ...
   private static boolean getMatchingCtmPng(RenderEngine var0) {
      Dimension var1 = var0.getTextureDimensions(var0.func_78341_b("/ctm.png"));
      if(var1 == null) {
         return false;
      } else {
         Dimension var2 = var0.getTextureDimensions(var0.func_78341_b("/terrain.png"));
   ...
   private static ConnectedProperties makeDefaultProperties(String var0, RenderEngine var1) {
      ...
      var3.textureId = var1.func_78341_b(var3.source);
      return var3;
   }
