      ...
      if(this.field_76852_a != null) {
         ...
         for(int var2 = 0; var2 < this.tileWidth; ++var2) {
            for(var3 = 0; var3 < this.tileWidth; ++var3) {
               float var4 = 0.0F;
               int var5 = (int)(MathHelper.func_76126_a((float)var3 * 3.141593F * 2.0F / 16.0F) * 1.2F);
               int var6 = (int)(MathHelper.func_76126_a((float)var2 * 3.141593F * 2.0F / 16.0F) * 1.2F);
         ...
         for(int var14 = 0; var14 < this.tileWidth * this.tileWidth; ++var14) {
            ...
            this.field_76852_a[var14 * 4 + 0] = (byte)var7;
            this.field_76852_a[var14 * 4 + 1] = (byte)var8;
            this.field_76852_a[var14 * 4 + 2] = (byte)var9;
            this.field_76852_a[var14 * 4 + 3] = -1;
         }
