...
public class WrUpdaterSmooth implements IWrUpdater {
   ...
   private void updateRenderersImpl(RenderGlobal var1, EntityLiving var2, boolean var3) {
      ...
      if(var1.field_72767_j.size() > 0) {
         ...
         int var9;
         for(var9 = 0; var9 < var1.field_72767_j.size(); ++var9) {
            WorldRendererSmooth var10 = (WorldRendererSmooth)var1.field_72767_j.get(var9);
            if(var10 != null) {
               ++this.renderersFound;
               if(!var10.field_78939_q) {
                  var1.field_72767_j.set(var9, (Object)null);
               } else {
                  float var11 = var10.func_78912_a(var2);
         ...
         if(this.currentUpdateRenderer == null || var4) {
            int var15;
            if(var6 != null) {
               var1.field_72767_j.set(var8, (Object)null);
               ...
               for(var15 = 0; var15 < var1.field_72767_j.size(); ++var15) {
                  WorldRendererSmooth var16 = (WorldRendererSmooth)var1.field_72767_j.get(var15);
                  if(var16 != null) {
                     float var12 = var16.func_78912_a(var2);
                     if(!var16.field_78927_l) {
                        var12 *= (float)var5;
                     }

                     float var13 = Math.abs(var12 - var7);
                     if(var13 < var14) {
                        var1.field_72767_j.set(var15, (Object)null);
            ...
            if(var1.field_72767_j.size() > 100 && this.renderersFound < var1.field_72767_j.size() * 4 / 5) {
               var9 = 0;

               for(var15 = 0; var15 < var1.field_72767_j.size(); ++var15) {
                  Object var17 = var1.field_72767_j.get(var15);
                  if(var17 != null) {
                     if(var15 != var9) {
                        var1.field_72767_j.set(var9, var17);
                     }
               ...
               for(var15 = var1.field_72767_j.size() - 1; var15 >= var9; --var15) {
                  var1.field_72767_j.remove(var15);
               }
            }
