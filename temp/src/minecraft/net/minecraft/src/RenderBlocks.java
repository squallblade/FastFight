...
public class RenderBlocks {
   ...
   public boolean func_78574_w(Block p_78574_1_, int p_78574_2_, int p_78574_3_, int p_78574_4_) {
      ...
      if(Reflector.ForgeBlock_getBedDirection.exists()) {
         var7 = Reflector.callInt(p_78574_1_, Reflector.ForgeBlock_getBedDirection, new Object[]{this.field_78669_a, Integer.valueOf(p_78574_2_), Integer.valueOf(p_78574_3_), Integer.valueOf(p_78574_4_)});
      }

      if(Reflector.ForgeBlock_isBedFoot.exists()) {
         var8 = Reflector.callBoolean(p_78574_1_, Reflector.ForgeBlock_isBedFoot, new Object[]{this.field_78669_a, Integer.valueOf(p_78574_2_), Integer.valueOf(p_78574_3_), Integer.valueOf(p_78574_4_)});
      }
      ...
      int var14 = p_78574_1_.func_71895_b(this.field_78669_a, p_78574_2_, p_78574_3_, p_78574_4_, 0);
      ...
      double var25 = (double)p_78574_2_ + this.field_83021_g;
      double var27 = (double)p_78574_2_ + this.field_83026_h;
      double var29 = (double)p_78574_3_ + this.field_83027_i + 0.1875D;
      double var31 = (double)p_78574_4_ + this.field_83025_k;
      double var33 = (double)p_78574_4_ + this.field_83022_l;
      var5.func_78374_a(var25, var29, var33, var17, var23);
      var5.func_78374_a(var25, var29, var31, var17, var21);
      var5.func_78374_a(var27, var29, var31, var19, var21);
      var5.func_78374_a(var27, var29, var33, var19, var23);
      ...
      var14 = p_78574_1_.func_71895_b(this.field_78669_a, p_78574_2_, p_78574_3_, p_78574_4_, 1);
      if(this.field_78664_d >= 0) {
         var14 = this.field_78664_d;
      }
      ...
      double var41 = (double)p_78574_2_ + this.field_83021_g;
      double var43 = (double)p_78574_2_ + this.field_83026_h;
      double var45 = (double)p_78574_3_ + this.field_83024_j;
      double var47 = (double)p_78574_4_ + this.field_83025_k;
      double var49 = (double)p_78574_4_ + this.field_83022_l;
      var5.func_78374_a(var43, var45, var49, var33, var37);
      var5.func_78374_a(var43, var45, var47, var25, var29);
      var5.func_78374_a(var41, var45, var47, var27, var31);
      var5.func_78374_a(var41, var45, var49, var35, var39);
      int var51 = Direction.field_71582_c[var7];
      if(var8) {
         var51 = Direction.field_71582_c[Direction.field_71580_e[var7]];
      }
      ...
      if(var51 != 2 && (this.field_78661_f || p_78574_1_.func_71877_c(this.field_78669_a, p_78574_2_, p_78574_3_, p_78574_4_ - 1, 2))) {
      ...
      if(var51 != 3 && (this.field_78661_f || p_78574_1_.func_71877_c(this.field_78669_a, p_78574_2_, p_78574_3_, p_78574_4_ + 1, 3))) {
      ...
      if(var51 != 4 && (this.field_78661_f || p_78574_1_.func_71877_c(this.field_78669_a, p_78574_2_ - 1, p_78574_3_, p_78574_4_, 4))) {
      ...
      if(var51 != 5 && (this.field_78661_f || p_78574_1_.func_71877_c(this.field_78669_a, p_78574_2_ + 1, p_78574_3_, p_78574_4_, 5))) {
   ...
   public boolean func_78615_a(BlockCauldron p_78615_1_, int p_78615_2_, int p_78615_3_, int p_78615_4_) {
      ...
      short var20 = 154;
      var11 = 0.125F;
      this.func_78605_f(p_78615_1_, (double)((float)p_78615_2_ - 1.0F + var11), (double)p_78615_3_, (double)p_78615_4_, var20);
      this.func_78573_e(p_78615_1_, (double)((float)p_78615_2_ + 1.0F - var11), (double)p_78615_3_, (double)p_78615_4_, var20);
      this.func_78622_d(p_78615_1_, (double)p_78615_2_, (double)p_78615_3_, (double)((float)p_78615_4_ - 1.0F + var11), var20);
      this.func_78611_c(p_78615_1_, (double)p_78615_2_, (double)p_78615_3_, (double)((float)p_78615_4_ + 1.0F - var11), var20);
      short var21 = 139;
      this.func_78617_b(p_78615_1_, (double)p_78615_2_, (double)((float)p_78615_3_ - 1.0F + 0.25F), (double)p_78615_4_, var21);
      this.func_78613_a(p_78615_1_, (double)p_78615_2_, (double)((float)p_78615_3_ + 1.0F - 0.75F), (double)p_78615_4_, var21);
      ...
      if(var14 > 0) {
         ...
         int var16 = CustomColorizer.getFluidColor(Block.field_71943_B, this.field_78669_a, p_78615_2_, p_78615_3_, p_78615_4_);
         float var17 = (float)(var16 >> 16 & 255) / 255.0F;
         float var18 = (float)(var16 >> 8 & 255) / 255.0F;
         float var19 = (float)(var16 & 255) / 255.0F;
         var5.func_78386_a(var17, var18, var19);
   ...
   public boolean func_78572_c(Block p_78572_1_, int p_78572_2_, int p_78572_3_, int p_78572_4_) {
      ...
      if(var5 == 1) {
         ...
         if(p_78572_1_ != Block.field_72069_aq && Config.isBetterSnow() && this.hasSnowNeighbours(p_78572_2_, p_78572_3_, p_78572_4_)) {
            this.renderSnow(p_78572_2_, p_78572_3_, p_78572_4_, Block.field_72037_aS.field_72022_cl);
         }
      }
   ...
   public boolean func_78594_e(Block p_78594_1_, int p_78594_2_, int p_78594_3_, int p_78594_4_) {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78594_2_, p_78594_3_, p_78594_4_)) {
         this.renderSnow(p_78594_2_, p_78594_3_, p_78594_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_78590_h(Block p_78590_1_, int p_78590_2_, int p_78590_3_, int p_78590_4_) {
      ...
      if(!this.field_78669_a.func_72797_t(p_78590_2_, p_78590_3_ - 1, p_78590_4_) && !Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_, p_78590_3_ - 1, p_78590_4_)) {
         ...
         if(Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_ - 1, p_78590_3_, p_78590_4_)) {
            var5.func_78374_a((double)((float)p_78590_2_ + var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 1), var11, var13);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)((float)p_78590_2_ + var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 0), var9, var13);
            var5.func_78374_a((double)((float)p_78590_2_ + var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 0), var9, var13);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1), var11, var15);
            var5.func_78374_a((double)((float)p_78590_2_ + var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 1), var11, var13);
         ...
         if(Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_ + 1, p_78590_3_, p_78590_4_)) {
            var5.func_78374_a((double)((float)(p_78590_2_ + 1) - var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 0), var9, var13);
            var5.func_78374_a((double)(p_78590_2_ + 1 - 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1 - 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1), var11, var15);
            var5.func_78374_a((double)((float)(p_78590_2_ + 1) - var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 1), var11, var13);
            var5.func_78374_a((double)((float)(p_78590_2_ + 1) - var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 1), var11, var13);
            var5.func_78374_a((double)(p_78590_2_ + 1 - 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1 - 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)((float)(p_78590_2_ + 1) - var36), (double)((float)p_78590_3_ + var17 + var33), (double)(p_78590_4_ + 0), var9, var13);
         ...
         if(Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_, p_78590_3_, p_78590_4_ - 1)) {
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17 + var33), (double)((float)p_78590_4_ + var36), var11, var13);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17 + var33), (double)((float)p_78590_4_ + var36), var9, var13);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17 + var33), (double)((float)p_78590_4_ + var36), var9, var13);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 0), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17 + var33), (double)((float)p_78590_4_ + var36), var11, var13);
         ...
         if(Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_, p_78590_3_, p_78590_4_ + 1)) {
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17 + var33), (double)((float)(p_78590_4_ + 1) - var36), var9, var13);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1 - 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1 - 0), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17 + var33), (double)((float)(p_78590_4_ + 1) - var36), var11, var13);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17 + var33), (double)((float)(p_78590_4_ + 1) - var36), var11, var13);
            var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1 - 0), var11, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)(p_78590_3_ + 0) + var33), (double)(p_78590_4_ + 1 - 0), var9, var15);
            var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17 + var33), (double)((float)(p_78590_4_ + 1) - var36), var9, var13);
         ...
         if(Block.field_72067_ar.func_72256_d(this.field_78669_a, p_78590_2_, p_78590_3_ + 1, p_78590_4_)) {
            ...
            if((p_78590_2_ + p_78590_3_ + p_78590_4_ & 1) == 0) {
               var5.func_78374_a(var26, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 0), var11, var13);
               var5.func_78374_a(var18, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 0), var11, var15);
               var5.func_78374_a(var18, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 1), var9, var15);
               var5.func_78374_a(var26, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 1), var9, var13);
               var9 = (double)((float)var7 / 256.0F);
               var11 = (double)(((float)var7 + 15.99F) / 256.0F);
               var13 = (double)((float)(var8 + 16) / 256.0F);
               var15 = (double)(((float)var8 + 15.99F + 16.0F) / 256.0F);
               var5.func_78374_a(var28, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 1), var11, var13);
               var5.func_78374_a(var20, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 1), var11, var15);
               var5.func_78374_a(var20, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 0), var9, var15);
               var5.func_78374_a(var28, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 0), var9, var13);
            } else {
               var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17), var34, var11, var13);
               var5.func_78374_a((double)(p_78590_2_ + 0), (double)(p_78590_3_ + 0), var24, var11, var15);
               ...
               var13 = (double)((float)(var8 + 16) / 256.0F);
               var15 = (double)(((float)var8 + 15.99F + 16.0F) / 256.0F);
               var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17), var30, var11, var13);
               var5.func_78374_a((double)(p_78590_2_ + 1), (double)(p_78590_3_ + 0), var22, var11, var15);
               var5.func_78374_a((double)(p_78590_2_ + 0), (double)(p_78590_3_ + 0), var22, var9, var15);
               var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17), var30, var9, var13);
            }
         }
      } else {
         ...
         var5.func_78374_a(var24, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 1), var11, var13);
         var5.func_78374_a(var32, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 1), var11, var15);
         var5.func_78374_a(var32, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 0), var9, var15);
         var5.func_78374_a(var24, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 0), var9, var13);
         var5.func_78374_a(var26, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 0), var11, var13);
         var5.func_78374_a(var18, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 0), var11, var15);
         var5.func_78374_a(var18, (double)(p_78590_3_ + 0), (double)(p_78590_4_ + 1), var9, var15);
         var5.func_78374_a(var26, (double)((float)p_78590_3_ + var17), (double)(p_78590_4_ + 1), var9, var13);
         ...
         var5.func_78374_a((double)(p_78590_2_ + 0), (double)(p_78590_3_ + 0), var22, var9, var15);
         var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17), var30, var9, var13);
         var5.func_78374_a((double)(p_78590_2_ + 0), (double)((float)p_78590_3_ + var17), var28, var11, var13);
         var5.func_78374_a((double)(p_78590_2_ + 0), (double)(p_78590_3_ + 0), var20, var11, var15);
         var5.func_78374_a((double)(p_78590_2_ + 1), (double)(p_78590_3_ + 0), var20, var9, var15);
         var5.func_78374_a((double)(p_78590_2_ + 1), (double)((float)p_78590_3_ + var17), var28, var9, var13);
   ...
   public boolean func_78589_i(Block p_78589_1_, int p_78589_2_, int p_78589_3_, int p_78589_4_) {
      ...
      boolean var24 = BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_ - 1, p_78589_3_, p_78589_4_, 1) || !this.field_78669_a.func_72809_s(p_78589_2_ - 1, p_78589_3_, p_78589_4_) && BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_ - 1, p_78589_3_ - 1, p_78589_4_, -1);
      boolean var25 = BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_ + 1, p_78589_3_, p_78589_4_, 3) || !this.field_78669_a.func_72809_s(p_78589_2_ + 1, p_78589_3_, p_78589_4_) && BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_ + 1, p_78589_3_ - 1, p_78589_4_, -1);
      boolean var26 = BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_, p_78589_3_, p_78589_4_ - 1, 2) || !this.field_78669_a.func_72809_s(p_78589_2_, p_78589_3_, p_78589_4_ - 1) && BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_, p_78589_3_ - 1, p_78589_4_ - 1, -1);
      boolean var27 = BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_, p_78589_3_, p_78589_4_ + 1, 0) || !this.field_78669_a.func_72809_s(p_78589_2_, p_78589_3_, p_78589_4_ + 1) && BlockRedstoneWire.func_72173_e(this.field_78669_a, p_78589_2_, p_78589_3_ - 1, p_78589_4_ + 1, -1);
      ...
      float var28 = (float)(p_78589_2_ + 0);
      float var29 = (float)(p_78589_2_ + 1);
      float var30 = (float)(p_78589_4_ + 0);
      float var31 = (float)(p_78589_4_ + 1);
      byte var32 = 0;
      ...
      if(var32 == 0) {
         ...
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var22);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var30, var18, var20);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var20);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var31, var33, var22);
         var5.func_78386_a(var8, var8, var8);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var22 + 0.0625D);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var30, var18, var20 + 0.0625D);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var20 + 0.0625D);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var31, var33, var22 + 0.0625D);
      } else if(var32 == 1) {
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var22);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var30, var18, var20);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var20);
         ...
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var22);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var22);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var20);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var20);
         var5.func_78386_a(var8, var8, var8);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var22 + 0.0625D);
         var5.func_78374_a((double)var29, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var22 + 0.0625D);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var30, var33, var20 + 0.0625D);
         var5.func_78374_a((double)var28, (double)p_78589_3_ + 0.015625D, (double)var31, var18, var20 + 0.0625D);
      }
      ...
      if(!this.field_78669_a.func_72809_s(p_78589_2_, p_78589_3_ + 1, p_78589_4_)) {
         ...
         if(this.field_78669_a.func_72809_s(p_78589_2_ - 1, p_78589_3_, p_78589_4_) && this.field_78669_a.func_72798_a(p_78589_2_ - 1, p_78589_3_ + 1, p_78589_4_) == Block.field_72075_av.field_71990_ca) {
            ...
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1), var18, var20);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1), var33, var20);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 0), var33, var22);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 0), var18, var22);
            var5.func_78386_a(var8, var8, var8);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1), var18, var20 + 0.0625D);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1), var33, var20 + 0.0625D);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 0), var33, var22 + 0.0625D);
            var5.func_78374_a((double)p_78589_2_ + 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 0), var18, var22 + 0.0625D);
         }

         if(this.field_78669_a.func_72809_s(p_78589_2_ + 1, p_78589_3_, p_78589_4_) && this.field_78669_a.func_72798_a(p_78589_2_ + 1, p_78589_3_ + 1, p_78589_4_) == Block.field_72075_av.field_71990_ca) {
            var5.func_78386_a(var8 * var10, var8 * var11, var8 * var12);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1), var33, var22);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1), var18, var22);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 0), var18, var20);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 0), var33, var20);
            var5.func_78386_a(var8, var8, var8);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1), var33, var22 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1), var18, var22 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 0), var18, var20 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 1) - 0.015625D, (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 0), var33, var20 + 0.0625D);
         }
         ...
         if(this.field_78669_a.func_72809_s(p_78589_2_, p_78589_3_, p_78589_4_ - 1) && this.field_78669_a.func_72798_a(p_78589_2_, p_78589_3_ + 1, p_78589_4_ - 1) == Block.field_72075_av.field_71990_ca) {
            var5.func_78386_a(var8 * var10, var8 * var11, var8 * var12);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)(p_78589_3_ + 0), (double)p_78589_4_ + 0.015625D, var33, var22);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)p_78589_4_ + 0.015625D, var18, var22);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)p_78589_4_ + 0.015625D, var18, var20);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)(p_78589_3_ + 0), (double)p_78589_4_ + 0.015625D, var33, var20);
            var5.func_78386_a(var8, var8, var8);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)(p_78589_3_ + 0), (double)p_78589_4_ + 0.015625D, var33, var22 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)p_78589_4_ + 0.015625D, var18, var22 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)p_78589_4_ + 0.015625D, var18, var20 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)(p_78589_3_ + 0), (double)p_78589_4_ + 0.015625D, var33, var20 + 0.0625D);
         }

         if(this.field_78669_a.func_72809_s(p_78589_2_, p_78589_3_, p_78589_4_ + 1) && this.field_78669_a.func_72798_a(p_78589_2_, p_78589_3_ + 1, p_78589_4_ + 1) == Block.field_72075_av.field_71990_ca) {
            var5.func_78386_a(var8 * var10, var8 * var11, var8 * var12);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1) - 0.015625D, var18, var20);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1) - 0.015625D, var33, var20);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1) - 0.015625D, var33, var22);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1) - 0.015625D, var18, var22);
            var5.func_78386_a(var8, var8, var8);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1) - 0.015625D, var18, var20 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 1), (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1) - 0.015625D, var33, var20 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)(p_78589_3_ + 0), (double)(p_78589_4_ + 1) - 0.015625D, var33, var22 + 0.0625D);
            var5.func_78374_a((double)(p_78589_2_ + 0), (double)((float)(p_78589_3_ + 1) + 0.021875F), (double)(p_78589_4_ + 1) - 0.015625D, var18, var22 + 0.0625D);
         }
      }

      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78589_2_, p_78589_3_, p_78589_4_)) {
         this.renderSnow(p_78589_2_, p_78589_3_, p_78589_4_, 0.01D);
      }
   ...
   public boolean func_78586_a(BlockRail p_78586_1_, int p_78586_2_, int p_78586_3_, int p_78586_4_) {
      ...
      var5.func_78374_a(var22, var38, var30, var12, var16);
      var5.func_78374_a(var20, var36, var28, var12, var14);
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78586_2_, p_78586_3_, p_78586_4_)) {
         this.renderSnow(p_78586_2_, p_78586_3_, p_78586_4_, 0.05D);
      }
   ...
   public boolean func_78576_j(Block p_78576_1_, int p_78576_2_, int p_78576_3_, int p_78576_4_) {
      ...
      int var8;
      if(Config.isConnectedTextures() && this.field_78664_d < 0) {
         int var7 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78576_1_, p_78576_2_, p_78576_3_, p_78576_4_, -1, var6);
         if(var7 >= 0) {
            var8 = var7 / 256;
            var5 = Tessellator.field_78398_a.getSubTessellator(var8);
            var6 = var7 % 256;
         }
      }
      ...
      float var23 = 1.0F;
      var5.func_78386_a(var23, var23, var23);
      var8 = (var6 & 15) << 4;
      int var9 = var6 & 240;
      double var10 = (double)((float)var8 / 256.0F);
      double var12 = (double)(((float)var8 + 15.99F) / 256.0F);
      double var14 = (double)((float)var9 / 256.0F);
      double var16 = (double)(((float)var9 + 15.99F) / 256.0F);
      int var18 = this.field_78669_a.func_72805_g(p_78576_2_, p_78576_3_, p_78576_4_);
      double var19 = 0.0D;
      double var21 = 0.05000000074505806D;
      if(var18 == 5) {
         var5.func_78374_a((double)p_78576_2_ + var21, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 1) + var19, var10, var14);
         var5.func_78374_a((double)p_78576_2_ + var21, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 1) + var19, var10, var16);
         var5.func_78374_a((double)p_78576_2_ + var21, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 0) - var19, var12, var16);
         var5.func_78374_a((double)p_78576_2_ + var21, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 0) - var19, var12, var14);
      }

      if(var18 == 4) {
         var5.func_78374_a((double)(p_78576_2_ + 1) - var21, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 1) + var19, var12, var16);
         var5.func_78374_a((double)(p_78576_2_ + 1) - var21, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 1) + var19, var12, var14);
         var5.func_78374_a((double)(p_78576_2_ + 1) - var21, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 0) - var19, var10, var14);
         var5.func_78374_a((double)(p_78576_2_ + 1) - var21, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 0) - var19, var10, var16);
      }

      if(var18 == 3) {
         var5.func_78374_a((double)(p_78576_2_ + 1) + var19, (double)(p_78576_3_ + 0) - var19, (double)p_78576_4_ + var21, var12, var16);
         var5.func_78374_a((double)(p_78576_2_ + 1) + var19, (double)(p_78576_3_ + 1) + var19, (double)p_78576_4_ + var21, var12, var14);
         var5.func_78374_a((double)(p_78576_2_ + 0) - var19, (double)(p_78576_3_ + 1) + var19, (double)p_78576_4_ + var21, var10, var14);
         var5.func_78374_a((double)(p_78576_2_ + 0) - var19, (double)(p_78576_3_ + 0) - var19, (double)p_78576_4_ + var21, var10, var16);
      }

      if(var18 == 2) {
         var5.func_78374_a((double)(p_78576_2_ + 1) + var19, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 1) - var21, var10, var14);
         var5.func_78374_a((double)(p_78576_2_ + 1) + var19, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 1) - var21, var10, var16);
         var5.func_78374_a((double)(p_78576_2_ + 0) - var19, (double)(p_78576_3_ + 0) - var19, (double)(p_78576_4_ + 1) - var21, var12, var16);
         var5.func_78374_a((double)(p_78576_2_ + 0) - var19, (double)(p_78576_3_ + 1) + var19, (double)(p_78576_4_ + 1) - var21, var12, var14);
      }
   ...
   public boolean func_78598_k(Block p_78598_1_, int p_78598_2_, int p_78598_3_, int p_78598_4_) {
      ...
      int var8;
      if(Config.isConnectedTextures() && this.field_78664_d < 0) {
         int var7 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78598_1_, p_78598_2_, p_78598_3_, p_78598_4_, -1, var6);
         if(var7 >= 0) {
            var8 = var7 / 256;
            var5 = Tessellator.field_78398_a.getSubTessellator(var8);
            var6 = var7 % 256;
      ...
      var8 = CustomColorizer.getColorMultiplier(p_78598_1_, this.field_78669_a, p_78598_2_, p_78598_3_, p_78598_4_);
      float var9 = (float)(var8 >> 16 & 255) / 255.0F;
      float var10 = (float)(var8 >> 8 & 255) / 255.0F;
      float var11 = (float)(var8 & 255) / 255.0F;
      var5.func_78386_a(var24 * var9, var24 * var10, var24 * var11);
      var8 = (var6 & 15) << 4;
      int var12 = var6 & 240;
      double var13 = (double)((float)var8 / 256.0F);
      double var15 = (double)(((float)var8 + 15.99F) / 256.0F);
      ...
      double var21 = 0.05000000074505806D;
      int var23 = this.field_78669_a.func_72805_g(p_78598_2_, p_78598_3_, p_78598_4_);
      if((var23 & 2) != 0) {
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1), var13, var17);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1), var13, var19);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 0), var15, var19);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 0), var15, var17);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 0), var15, var17);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 0), var15, var19);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1), var13, var19);
         var5.func_78374_a((double)p_78598_2_ + var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1), var13, var17);
      ...
      if((var23 & 8) != 0) {
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1), var15, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1), var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 0), var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 0), var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 0), var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 0), var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1), var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1) - var21, (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1), var15, var19);
      ...
      if((var23 & 4) != 0) {
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 0), (double)p_78598_4_ + var21, var15, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1), (double)p_78598_4_ + var21, var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1), (double)p_78598_4_ + var21, var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 0), (double)p_78598_4_ + var21, var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 0), (double)p_78598_4_ + var21, var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1), (double)p_78598_4_ + var21, var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1), (double)p_78598_4_ + var21, var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 0), (double)p_78598_4_ + var21, var15, var19);
      ...
      if((var23 & 1) != 0) {
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1) - var21, var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1) - var21, var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1) - var21, var15, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1) - var21, var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1) - var21, var15, var17);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1) - var21, var15, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 0), (double)(p_78598_4_ + 1) - var21, var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1), (double)(p_78598_4_ + 1) - var21, var13, var17);
      ...
      if(this.field_78669_a.func_72809_s(p_78598_2_, p_78598_3_ + 1, p_78598_4_)) {
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1) - var21, (double)(p_78598_4_ + 0), var13, var17);
         var5.func_78374_a((double)(p_78598_2_ + 1), (double)(p_78598_3_ + 1) - var21, (double)(p_78598_4_ + 1), var13, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1) - var21, (double)(p_78598_4_ + 1), var15, var19);
         var5.func_78374_a((double)(p_78598_2_ + 0), (double)(p_78598_3_ + 1) - var21, (double)(p_78598_4_ + 0), var15, var17);
      }
   ...
   public boolean func_78592_a(BlockPane p_78592_1_, int p_78592_2_, int p_78592_3_, int p_78592_4_) {
      ...
      Tessellator var6 = Tessellator.field_78398_a;
      boolean var7 = p_78592_1_ == Block.field_72003_bq && ConnectedTextures.isConnectedGlassPanes();
      Tessellator var8 = var6;
      var6.func_78380_c(p_78592_1_.func_71874_e(this.field_78669_a, p_78592_2_, p_78592_3_, p_78592_4_));
      float var10 = 1.0F;
      int var11 = p_78592_1_.func_71920_b(this.field_78669_a, p_78592_2_, p_78592_3_, p_78592_4_);
      ...
      var6.func_78386_a(var10 * var12, var10 * var13, var10 * var14);
      ...
      int var113;
      if(this.field_78664_d >= 0) {
         var113 = this.field_78664_d;
         var111 = this.field_78664_d;
         var7 = false;
      } else {
         var114 = this.field_78669_a.func_72805_g(p_78592_2_, p_78592_3_, p_78592_4_);
         var113 = p_78592_1_.func_71858_a(0, var114);
         var111 = p_78592_1_.func_72162_n();
         if(var7) {
            var18 = Config.getMinecraft().field_71446_o.func_78341_b("/ctm.png");
            var8 = Tessellator.field_78398_a.getSubTessellator(var18);
            var113 = 0;
         }
      }
      ...
      var18 = var113;
      int var19 = var113;
      int var20 = this.field_78669_a.func_72798_a(p_78592_2_ + 1, p_78592_3_, p_78592_4_);
      int var21 = this.field_78669_a.func_72798_a(p_78592_2_ - 1, p_78592_3_, p_78592_4_);
      int var22 = this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_, p_78592_4_ + 1);
      int var23 = this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_, p_78592_4_ - 1);
      int var25;
      int var24;
      if(var7) {
         var24 = Block.field_72003_bq.field_71990_ca;
         var25 = this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_ + 1, p_78592_4_);
         int var26 = this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_ - 1, p_78592_4_);
      ...
      double var84 = (double)p_78592_2_;
      double var86 = (double)p_78592_2_ + 0.5D;
      double var88 = (double)(p_78592_2_ + 1);
      double var90 = (double)p_78592_4_;
      double var92 = (double)p_78592_4_ + 0.5D;
      double var94 = (double)(p_78592_4_ + 1);
      double var96 = (double)p_78592_2_ + 0.5D - 0.0625D;
      double var98 = (double)p_78592_2_ + 0.5D + 0.0625D;
      double var100 = (double)p_78592_4_ + 0.5D - 0.0625D;
      double var102 = (double)p_78592_4_ + 0.5D + 0.0625D;
      boolean var104 = p_78592_1_.func_72161_e(this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_, p_78592_4_ - 1));
      boolean var105 = p_78592_1_.func_72161_e(this.field_78669_a.func_72798_a(p_78592_2_, p_78592_3_, p_78592_4_ + 1));
      boolean var106 = p_78592_1_.func_72161_e(this.field_78669_a.func_72798_a(p_78592_2_ - 1, p_78592_3_, p_78592_4_));
      boolean var107 = p_78592_1_.func_72161_e(this.field_78669_a.func_72798_a(p_78592_2_ + 1, p_78592_3_, p_78592_4_));
      boolean var108 = p_78592_1_.func_71877_c(this.field_78669_a, p_78592_2_, p_78592_3_ + 1, p_78592_4_, 1);
      boolean var109 = p_78592_1_.func_71877_c(this.field_78669_a, p_78592_2_, p_78592_3_ - 1, p_78592_4_, 0);
      if((!var106 || !var107) && (var106 || var107 || var104 || var105)) {
         if(var106 && !var107) {
            var8.func_78374_a(var84, (double)(p_78592_3_ + 1), var92, var116, var118);
            var8.func_78374_a(var84, (double)(p_78592_3_ + 0), var92, var116, var34);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var115, var34);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var115, var118);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var40, var44);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var40, var46);
            var8.func_78374_a(var84, (double)(p_78592_3_ + 0), var92, var42, var46);
            var8.func_78374_a(var84, (double)(p_78592_3_ + 1), var92, var42, var44);
            if(!var105 && !var104) {
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1), var102, var74, var78);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 0), var102, var74, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 0), var100, var76, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1), var100, var76, var78);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1), var100, var74, var78);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 0), var100, var74, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 0), var102, var76, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1), var102, var76, var78);
            }

            if(var108 || p_78592_3_ < var5 - 1 && this.field_78669_a.func_72799_c(p_78592_2_ - 1, p_78592_3_ + 1, p_78592_4_)) {
               var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var80);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var82);
               var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var80);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var80);
               var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var82);
               var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var82);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var80);
            }

            if(var109 || p_78592_3_ > 1 && this.field_78669_a.func_72799_c(p_78592_2_ - 1, p_78592_3_ - 1, p_78592_4_)) {
               var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var102, var76, var80);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var102, var76, var82);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var100, var74, var82);
               var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var100, var74, var80);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var102, var76, var80);
               var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var102, var76, var82);
               var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var100, var74, var82);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var100, var74, var80);
            }
         } else if(!var106 && var107) {
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var115, var118);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var115, var34);
            var8.func_78374_a(var88, (double)(p_78592_3_ + 0), var92, var117, var34);
            var8.func_78374_a(var88, (double)(p_78592_3_ + 1), var92, var117, var118);
            var8.func_78374_a(var88, (double)(p_78592_3_ + 1), var92, var38, var44);
            var8.func_78374_a(var88, (double)(p_78592_3_ + 0), var92, var38, var46);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var40, var46);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var40, var44);
            if(!var105 && !var104) {
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1), var100, var74, var78);
            ...
            if(var108 || p_78592_3_ < var5 - 1 && this.field_78669_a.func_72799_c(p_78592_2_ + 1, p_78592_3_ + 1, p_78592_4_)) {
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var78);
               var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var80);
               var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var80);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var78);
               var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var78);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var80);
               var6.func_78374_a(var86, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var80);
               var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var78);
            }

            if(var109 || p_78592_3_ > 1 && this.field_78669_a.func_72799_c(p_78592_2_ + 1, p_78592_3_ - 1, p_78592_4_)) {
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var102, var76, var78);
               var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var102, var76, var80);
               var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var100, var74, var80);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var100, var74, var78);
               var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var102, var76, var78);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var102, var76, var80);
               var6.func_78374_a(var86, (double)p_78592_3_ - 0.01D, var100, var74, var80);
               var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var100, var74, var78);
            }
         }
      } else {
         var8.func_78374_a(var84, (double)(p_78592_3_ + 1), var92, var116, var118);
         ...
         if(var108) {
            ...
            var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var78);
            var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var82);
            var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var82);
            var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var102, var76, var78);
            var6.func_78374_a(var84, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var78);
            var6.func_78374_a(var88, (double)(p_78592_3_ + 1) + 0.01D, var100, var74, var82);
         } else {
         ...
         if(var109) {
            ...
            var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var100, var74, var78);
            var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var100, var74, var82);
            var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var102, var76, var82);
            var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var102, var76, var78);
            var6.func_78374_a(var84, (double)p_78592_3_ - 0.01D, var100, var74, var78);
            var6.func_78374_a(var88, (double)p_78592_3_ - 0.01D, var100, var74, var82);
         } else {
      ...
      if((!var104 || !var105) && (var106 || var107 || var104 || var105)) {
         if(var104 && !var105) {
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var90, var50, var56);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var90, var50, var58);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var52, var58);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var52, var56);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var64, var68);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var64, var70);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var90, var66, var70);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var90, var66, var68);
            if(!var107 && !var106) {
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var74, var78);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 0), var92, var74, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 0), var92, var76, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var76, var78);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var74, var78);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 0), var92, var74, var82);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 0), var92, var76, var82);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var76, var78);
            }

            if(var108 || p_78592_3_ < var5 - 1 && this.field_78669_a.func_72799_c(p_78592_2_, p_78592_3_ + 1, p_78592_4_ - 1)) {
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var90, var76, var78);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var76, var80);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var74, var80);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var90, var74, var78);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var76, var78);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var90, var76, var80);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var90, var74, var80);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var74, var78);
            }

            if(var109 || p_78592_3_ > 1 && this.field_78669_a.func_72799_c(p_78592_2_, p_78592_3_ - 1, p_78592_4_ - 1)) {
               var6.func_78374_a(var96, (double)p_78592_3_, var90, var76, var78);
               var6.func_78374_a(var96, (double)p_78592_3_, var92, var76, var80);
               var6.func_78374_a(var98, (double)p_78592_3_, var92, var74, var80);
               var6.func_78374_a(var98, (double)p_78592_3_, var90, var74, var78);
               var6.func_78374_a(var96, (double)p_78592_3_, var92, var76, var78);
               var6.func_78374_a(var96, (double)p_78592_3_, var90, var76, var80);
               var6.func_78374_a(var98, (double)p_78592_3_, var90, var74, var80);
               var6.func_78374_a(var98, (double)p_78592_3_, var92, var74, var78);
            }
         } else if(!var104 && var105) {
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var52, var56);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var52, var58);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var94, var54, var58);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var94, var54, var56);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var94, var62, var68);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var94, var62, var70);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 0), var92, var64, var70);
            var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var92, var64, var68);
            if(!var107 && !var106) {
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var74, var78);
            ...
            if(var108 || p_78592_3_ < var5 - 1 && this.field_78669_a.func_72799_c(p_78592_2_, p_78592_3_ + 1, p_78592_4_ + 1)) {
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var74, var80);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var94, var74, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var94, var76, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var76, var80);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var94, var74, var80);
               var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var92, var74, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var92, var76, var82);
               var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var94, var76, var80);
            }

            if(var109 || p_78592_3_ > 1 && this.field_78669_a.func_72799_c(p_78592_2_, p_78592_3_ - 1, p_78592_4_ + 1)) {
               var6.func_78374_a(var96, (double)p_78592_3_, var92, var74, var80);
               var6.func_78374_a(var96, (double)p_78592_3_, var94, var74, var82);
               var6.func_78374_a(var98, (double)p_78592_3_, var94, var76, var82);
               var6.func_78374_a(var98, (double)p_78592_3_, var92, var76, var80);
               var6.func_78374_a(var96, (double)p_78592_3_, var94, var74, var80);
               var6.func_78374_a(var96, (double)p_78592_3_, var92, var74, var82);
               var6.func_78374_a(var98, (double)p_78592_3_, var92, var76, var82);
               var6.func_78374_a(var98, (double)p_78592_3_, var94, var76, var80);
            }
         }
      } else {
         var8.func_78374_a(var86, (double)(p_78592_3_ + 1), var94, var62, var68);
         ...
         if(var108) {
            var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var94, var76, var82);
            var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var90, var76, var78);
            var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var90, var74, var78);
            var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var94, var74, var82);
            var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var90, var76, var82);
            var6.func_78374_a(var98, (double)(p_78592_3_ + 1), var94, var76, var78);
            var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var94, var74, var78);
            var6.func_78374_a(var96, (double)(p_78592_3_ + 1), var90, var74, var82);
         } else {
         ...
         if(var109) {
            var6.func_78374_a(var98, (double)p_78592_3_, var94, var76, var82);
            var6.func_78374_a(var98, (double)p_78592_3_, var90, var76, var78);
            var6.func_78374_a(var96, (double)p_78592_3_, var90, var74, var78);
            var6.func_78374_a(var96, (double)p_78592_3_, var94, var74, var82);
            var6.func_78374_a(var98, (double)p_78592_3_, var90, var76, var82);
            var6.func_78374_a(var98, (double)p_78592_3_, var94, var76, var78);
            var6.func_78374_a(var96, (double)p_78592_3_, var94, var74, var78);
            var6.func_78374_a(var96, (double)p_78592_3_, var90, var74, var82);
         } else {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78592_2_, p_78592_3_, p_78592_4_)) {
         this.renderSnow(p_78592_2_, p_78592_3_, p_78592_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_78620_l(Block p_78620_1_, int p_78620_2_, int p_78620_3_, int p_78620_4_) {
      ...
      float var6 = 1.0F;
      int var7 = CustomColorizer.getColorMultiplier(p_78620_1_, this.field_78669_a, p_78620_2_, p_78620_3_, p_78620_4_);
      float var8 = (float)(var7 >> 16 & 255) / 255.0F;
      float var9 = (float)(var7 >> 8 & 255) / 255.0F;
      float var10 = (float)(var7 & 255) / 255.0F;
      if(EntityRenderer.field_78517_a) {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78620_2_, p_78620_3_, p_78620_4_)) {
         this.renderSnow(p_78620_2_, p_78620_3_, p_78620_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_78603_m(Block p_78603_1_, int p_78603_2_, int p_78603_3_, int p_78603_4_) {
      ...
      float var7 = 1.0F;
      int var8 = CustomColorizer.getStemColorMultiplier(var5, this.field_78669_a, p_78603_2_, p_78603_3_, p_78603_4_);
      float var9 = (float)(var8 >> 16 & 255) / 255.0F;
      float var10 = (float)(var8 >> 8 & 255) / 255.0F;
      float var11 = (float)(var8 & 255) / 255.0F;
      if(EntityRenderer.field_78517_a) {
   ...
   public void func_78599_a(Block p_78599_1_, int p_78599_2_, double p_78599_3_, double p_78599_5_, double p_78599_7_, float p_78599_9_) {
      ...
      int var13;
      if(Config.isConnectedTextures() && this.field_78664_d < 0) {
         var12 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78599_1_, (int)p_78599_3_, (int)p_78599_5_, (int)p_78599_7_, -1, var11);
         if(var12 >= 0) {
            var13 = var12 / 256;
            var10 = Tessellator.field_78398_a.getSubTessellator(var13);
            var11 = var12 % 256;
         }
      }
   ...
   public boolean func_78566_o(Block p_78566_1_, int p_78566_2_, int p_78566_3_, int p_78566_4_) {
      ...
      int var8;
      if(Config.isConnectedTextures() && this.field_78664_d < 0) {
         var7 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78566_1_, p_78566_2_, p_78566_3_, p_78566_4_, -1, var6);
         if(var7 >= 0) {
            var8 = var7 / 256;
            var5 = Tessellator.field_78398_a.getSubTessellator(var8);
            var6 = var7 % 256;
      ...
      var5.func_78378_d((var25 & 16711422) >> 1);
      var5.func_78374_a((double)(var21 - var23 - var24), (double)((float)p_78566_3_ + var9), (double)(var22 + var23 - var24), var10, var16);
      var5.func_78374_a((double)(var21 - var23 + var24), (double)((float)p_78566_3_ + var9), (double)(var22 - var23 - var24), var12, var16);
      var5.func_78374_a((double)(var21 + var23 + var24), (double)((float)p_78566_3_ + var9), (double)(var22 - var23 + var24), var12, var14);
      var5.func_78374_a((double)(var21 + var23 - var24), (double)((float)p_78566_3_ + var9), (double)(var22 + var23 + var24), var10, var14);
   ...
   public boolean func_78621_p(Block p_78621_1_, int p_78621_2_, int p_78621_3_, int p_78621_4_) {
      Tessellator var5 = Tessellator.field_78398_a;
      int var6 = CustomColorizer.getFluidColor(p_78621_1_, this.field_78669_a, p_78621_2_, p_78621_3_, p_78621_4_);
      ...
      if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
         ...
         if(this.field_78661_f || var10) {
            ...
            var36 = (float)BlockFluid.func_72204_a(this.field_78669_a, p_78621_2_, p_78621_3_, p_78621_4_, var22);
            if(var36 > -999.0F) {
            ...
            var42 = (double)(MathHelper.func_76126_a(var36) * 8.0F) / 256.0D;
            var44 = (double)(MathHelper.func_76134_b(var36) * 8.0F) / 256.0D;
            ...
            var5.func_78374_a((double)(p_78621_2_ + 0), (double)p_78621_3_ + var24, (double)(p_78621_4_ + 0), var38 - var44 - var42 + var47, var40 - var44 + var42 + var47);
            var5.func_78374_a((double)(p_78621_2_ + 0), (double)p_78621_3_ + var26, (double)(p_78621_4_ + 1), var38 - var44 + var42 + var47, var40 + var44 + var42 - var47);
            var5.func_78374_a((double)(p_78621_2_ + 1), (double)p_78621_3_ + var28, (double)(p_78621_4_ + 1), var38 + var44 + var42 - var47, var40 + var44 - var42 - var47);
            var5.func_78374_a((double)(p_78621_2_ + 1), (double)p_78621_3_ + var30, (double)(p_78621_4_ + 0), var38 + var44 - var42 - var47, var40 - var44 - var42 + var47);
         }
         ...
         if(this.field_78661_f || var11) {
            ...
            var36 = 1.0F;
            var5.func_78386_a(var14 * var36 * var7, var14 * var36 * var8, var14 * var36 * var9);
         ...
         for(var34 = 0; var34 < 4; ++var34) {
            ...
            var37 = p_78621_1_.func_71858_a(var34 + 2, var23);
            ...
            if(this.field_78661_f || var12[var34]) {
               ...
               if(var34 == 0) {
                  var42 = var24;
                  var40 = var30;
                  var65 = (double)p_78621_2_;
                  var50 = (double)(p_78621_2_ + 1);
                  var44 = (double)p_78621_4_ + var32;
                  var48 = (double)p_78621_4_ + var32;
               } else if(var34 == 1) {
                  var42 = var28;
                  var40 = var26;
                  var65 = (double)(p_78621_2_ + 1);
                  var50 = (double)p_78621_2_;
                  var44 = (double)(p_78621_4_ + 1) - var32;
                  var48 = (double)(p_78621_4_ + 1) - var32;
               } else if(var34 == 2) {
                  var42 = var26;
                  var40 = var24;
                  var65 = (double)p_78621_2_ + var32;
                  var50 = (double)p_78621_2_ + var32;
                  var44 = (double)(p_78621_4_ + 1);
                  var48 = (double)p_78621_4_;
               } else {
                  var42 = var30;
                  var40 = var28;
                  var65 = (double)(p_78621_2_ + 1) - var32;
                  var50 = (double)(p_78621_2_ + 1) - var32;
                  var44 = (double)p_78621_4_;
               ...
               var5.func_78380_c(p_78621_1_.func_71874_e(this.field_78669_a, var64, p_78621_3_, var35));
               float var62 = 1.0F;
               if(var34 < 2) {
                  var62 *= var16;
               } else {
               ...
               var5.func_78386_a(var15 * var62 * var7, var15 * var62 * var8, var15 * var62 * var9);
               var5.func_78374_a(var65, (double)p_78621_3_ + var42, var44, var52, var56);
               var5.func_78374_a(var50, (double)p_78621_3_ + var40, var48, var54, var58);
               var5.func_78374_a(var50, (double)(p_78621_3_ + 0), var48, var54, var60);
               var5.func_78374_a(var65, (double)(p_78621_3_ + 0), var44, var52, var60);
            }
         }
   ...
   public boolean func_78570_q(Block p_78570_1_, int p_78570_2_, int p_78570_3_, int p_78570_4_) {
      int var5 = CustomColorizer.getColorMultiplier(p_78570_1_, this.field_78669_a, p_78570_2_, p_78570_3_, p_78570_4_);
   ...
   public boolean func_78578_a(Block p_78578_1_, int p_78578_2_, int p_78578_3_, int p_78578_4_, float p_78578_5_, float p_78578_6_, float p_78578_7_) {
      ...
      boolean var8 = Tessellator.field_78398_a.defaultTexture;
      boolean var9 = Config.isBetterGrass() && var8;
      if(p_78578_1_.getClass() == BlockGlass.class) {
         this.field_78698_am = 0;
      } else {
         this.field_78698_am = 1;
      }
      ...
      int var17 = p_78578_1_.func_71874_e(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_);
      Tessellator var18 = Tessellator.field_78398_a;
      var18.func_78380_c(983055);
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_, 0)) {
         if(!this.aoLightValuesCalculated) {
            this.calculateAoLightValues(p_78578_1_, p_78578_2_, p_78578_3_, p_78578_4_);
         }

         var19 = var17;
         if(this.field_83027_i <= 0.0D) {
            var19 = p_78578_1_.func_71874_e(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_);
         }
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78689_v = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_);
            this.field_78712_x = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1);
            this.field_78710_y = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1);
            this.field_78628_A = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_);
            if(!this.field_78644_aL && !this.field_78647_aN) {
               this.field_78691_u = this.field_78689_v;
               this.field_78649_S = this.field_78641_T;
            } else {
               this.field_78691_u = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_ - 1);
            ...
            if(!this.field_78648_aO && !this.field_78647_aN) {
               ...
               this.field_78687_w = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_ + 1);
            ...
            if(!this.field_78644_aL && !this.field_78646_aM) {
               ...
               this.field_78708_z = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_ - 1);
            ...
            if(!this.field_78648_aO && !this.field_78646_aM) {
               ...
               this.field_78629_B = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_ + 1);
            ...
            var20 = (this.field_78687_w + this.field_78689_v + this.field_78710_y + this.field_78701_p) / 4.0F;
            var23 = (this.field_78710_y + this.field_78701_p + this.field_78629_B + this.field_78628_A) / 4.0F;
            var22 = (this.field_78701_p + this.field_78712_x + this.field_78628_A + this.field_78708_z) / 4.0F;
            var21 = (this.field_78689_v + this.field_78691_u + this.field_78701_p + this.field_78712_x) / 4.0F;
            this.field_78700_an = this.func_78602_a(this.field_78639_U, this.field_78641_T, this.field_78643_W, var19);
            this.field_78676_aq = this.func_78602_a(this.field_78643_W, this.field_78660_Z, this.field_78655_Y, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78645_V, this.field_78655_Y, this.field_78657_X, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78641_T, this.field_78649_S, this.field_78645_V, var19);
         } else {
            var23 = this.field_78701_p;
            var22 = this.field_78701_p;
            var21 = this.field_78701_p;
            var20 = this.field_78701_p;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = (var11?p_78578_5_:1.0F) * 0.5F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = (var11?p_78578_6_:1.0F) * 0.5F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = (var11?p_78578_7_:1.0F) * 0.5F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
         this.field_78680_aw *= var21;
         this.field_78650_aA *= var21;
         this.field_78670_at *= var22;
         this.field_78678_ax *= var22;
         this.field_78651_aB *= var22;
         this.field_78684_au *= var23;
         this.field_78665_ay *= var23;
         this.field_78652_aC *= var23;
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_, 1)) {
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78624_D = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_);
            this.field_78634_H = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_);
            this.field_78626_F = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1);
            this.field_78635_I = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1);
            if(!this.field_78653_aD && !this.field_78656_aF) {
               this.field_78630_C = this.field_78624_D;
               this.field_78704_aa = this.field_78705_ab;
            } else {
               this.field_78630_C = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_ - 1);
            ...
            if(!this.field_78653_aD && !this.field_78654_aE) {
               ...
               this.field_78627_G = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_ - 1);
            ...
            if(!this.field_78658_aG && !this.field_78656_aF) {
               ...
               this.field_78625_E = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_ + 1);
            ...
            if(!this.field_78658_aG && !this.field_78654_aE) {
               ...
               this.field_78636_J = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_ + 1);
            ...
            var23 = (this.field_78625_E + this.field_78624_D + this.field_78635_I + this.field_78695_s) / 4.0F;
            var20 = (this.field_78635_I + this.field_78695_s + this.field_78636_J + this.field_78634_H) / 4.0F;
            var21 = (this.field_78695_s + this.field_78626_F + this.field_78634_H + this.field_78627_G) / 4.0F;
            var22 = (this.field_78624_D + this.field_78630_C + this.field_78695_s + this.field_78626_F) / 4.0F;
            this.field_78676_aq = this.func_78602_a(this.field_78702_ac, this.field_78705_ab, this.field_78706_ag, var19);
            this.field_78700_an = this.func_78602_a(this.field_78706_ag, this.field_78707_ah, this.field_78711_af, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78703_ad, this.field_78711_af, this.field_78709_ae, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78705_ab, this.field_78704_aa, this.field_78703_ad, var19);
         } else {
            var23 = this.field_78695_s;
            var22 = this.field_78695_s;
            var21 = this.field_78695_s;
            var20 = this.field_78695_s;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = var12?p_78578_5_:1.0F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = var12?p_78578_6_:1.0F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = var12?p_78578_7_:1.0F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1, 2)) {
         ...
         if(this.field_83025_k <= 0.0D) {
            var19 = p_78578_1_.func_71874_e(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1);
         }
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78637_K = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_);
            this.field_78712_x = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_);
            this.field_78626_F = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_);
            this.field_78631_L = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_);
            ...
            if(!this.field_78659_aH && !this.field_78644_aL) {
               ...
               this.field_78691_u = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_ - 1, p_78578_4_);
            ...
            if(!this.field_78659_aH && !this.field_78653_aD) {
               ...
               this.field_78630_C = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_ + 1, p_78578_4_);
            ...
            if(!this.field_78642_aK && !this.field_78644_aL) {
               ...
               this.field_78708_z = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_ - 1, p_78578_4_);
            ...
            if(!this.field_78642_aK && !this.field_78653_aD) {
               ...
               this.field_78627_G = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_ + 1, p_78578_4_);
            ...
            var20 = (this.field_78637_K + this.field_78630_C + this.field_78699_q + this.field_78626_F) / 4.0F;
            var21 = (this.field_78699_q + this.field_78626_F + this.field_78631_L + this.field_78627_G) / 4.0F;
            var22 = (this.field_78712_x + this.field_78699_q + this.field_78708_z + this.field_78631_L) / 4.0F;
            var23 = (this.field_78691_u + this.field_78637_K + this.field_78712_x + this.field_78699_q) / 4.0F;
            this.field_78700_an = this.func_78602_a(this.field_78690_ai, this.field_78704_aa, this.field_78703_ad, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78703_ad, this.field_78692_aj, this.field_78709_ae, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78645_V, this.field_78657_X, this.field_78692_aj, var19);
            this.field_78676_aq = this.func_78602_a(this.field_78649_S, this.field_78690_ai, this.field_78645_V, var19);
         } else {
            var23 = this.field_78699_q;
            var22 = this.field_78699_q;
            var21 = this.field_78699_q;
            var20 = this.field_78699_q;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = (var13?p_78578_5_:1.0F) * 0.8F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = (var13?p_78578_6_:1.0F) * 0.8F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = (var13?p_78578_7_:1.0F) * 0.8F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
         ...
         this.field_78665_ay *= var23;
         this.field_78652_aC *= var23;
         var24 = p_78578_1_.func_71895_b(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 2);
         if(var9) {
            var24 = this.fixAoSideGrassTexture(var24, p_78578_2_, p_78578_3_, p_78578_4_, 2, p_78578_5_, p_78578_6_, p_78578_7_);
         }

         this.func_78611_c(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var24);
         if(var8 && field_78667_b && var24 == 3 && this.field_78664_d < 0) {
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1, 3)) {
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78632_M = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_);
            this.field_78633_N = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_);
            this.field_78710_y = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_);
            this.field_78635_I = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_);
            ...
            if(!this.field_78640_aJ && !this.field_78648_aO) {
               ...
               this.field_78687_w = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_ - 1, p_78578_4_);
            ...
            if(!this.field_78640_aJ && !this.field_78658_aG) {
               ...
               this.field_78625_E = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ - 1, p_78578_3_ + 1, p_78578_4_);
            ...
            if(!this.field_78638_aI && !this.field_78648_aO) {
               ...
               this.field_78629_B = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_ - 1, p_78578_4_);
            ...
            if(!this.field_78638_aI && !this.field_78658_aG) {
               ...
               this.field_78636_J = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_ + 1, p_78578_3_ + 1, p_78578_4_);
            ...
            var20 = (this.field_78632_M + this.field_78625_E + this.field_78693_t + this.field_78635_I) / 4.0F;
            var23 = (this.field_78693_t + this.field_78635_I + this.field_78633_N + this.field_78636_J) / 4.0F;
            var22 = (this.field_78710_y + this.field_78693_t + this.field_78629_B + this.field_78633_N) / 4.0F;
            var21 = (this.field_78687_w + this.field_78632_M + this.field_78710_y + this.field_78693_t) / 4.0F;
            this.field_78700_an = this.func_78602_a(this.field_78686_ak, this.field_78702_ac, this.field_78706_ag, var19);
            this.field_78676_aq = this.func_78602_a(this.field_78706_ag, this.field_78688_al, this.field_78707_ah, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78643_W, this.field_78660_Z, this.field_78688_al, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78639_U, this.field_78686_ak, this.field_78643_W, var19);
         } else {
            var23 = this.field_78693_t;
            var22 = this.field_78693_t;
            var21 = this.field_78693_t;
            var20 = this.field_78693_t;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = (var14?p_78578_5_:1.0F) * 0.8F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = (var14?p_78578_6_:1.0F) * 0.8F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = (var14?p_78578_7_:1.0F) * 0.8F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
         ...
         this.field_78665_ay *= var23;
         this.field_78652_aC *= var23;
         var24 = p_78578_1_.func_71895_b(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 3);
         if(var9) {
            var24 = this.fixAoSideGrassTexture(var24, p_78578_2_, p_78578_3_, p_78578_4_, 3, p_78578_5_, p_78578_6_, p_78578_7_);
         }

         this.func_78622_d(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var24);
         if(var8 && field_78667_b && var24 == 3 && this.field_78664_d < 0) {
            this.field_78674_ar *= p_78578_5_;
            this.field_78672_as *= p_78578_5_;
            this.field_78670_at *= p_78578_5_;
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_, 4)) {
         ...
         if(this.field_83021_g <= 0.0D) {
            var19 = p_78578_1_.func_71874_e(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_);
         }
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78689_v = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_);
            this.field_78637_K = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1);
            this.field_78632_M = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1);
            this.field_78624_D = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_);
            ...
            if(!this.field_78659_aH && !this.field_78647_aN) {
               ...
               this.field_78691_u = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_ - 1);
            ...
            if(!this.field_78640_aJ && !this.field_78647_aN) {
               ...
               this.field_78687_w = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_ + 1);
            ...
            if(!this.field_78659_aH && !this.field_78656_aF) {
               ...
               this.field_78630_C = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_ - 1);
            ...
            if(!this.field_78640_aJ && !this.field_78656_aF) {
               ...
               this.field_78625_E = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_ + 1);
            ...
            var23 = (this.field_78689_v + this.field_78687_w + this.field_78673_o + this.field_78632_M) / 4.0F;
            var20 = (this.field_78673_o + this.field_78632_M + this.field_78624_D + this.field_78625_E) / 4.0F;
            var21 = (this.field_78637_K + this.field_78673_o + this.field_78630_C + this.field_78624_D) / 4.0F;
            var22 = (this.field_78691_u + this.field_78689_v + this.field_78637_K + this.field_78673_o) / 4.0F;
            this.field_78676_aq = this.func_78602_a(this.field_78641_T, this.field_78639_U, this.field_78686_ak, var19);
            this.field_78700_an = this.func_78602_a(this.field_78686_ak, this.field_78705_ab, this.field_78702_ac, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78690_ai, this.field_78704_aa, this.field_78705_ab, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78649_S, this.field_78641_T, this.field_78690_ai, var19);
         } else {
            var23 = this.field_78673_o;
            var22 = this.field_78673_o;
            var21 = this.field_78673_o;
            var20 = this.field_78673_o;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = (var15?p_78578_5_:1.0F) * 0.6F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = (var15?p_78578_6_:1.0F) * 0.6F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = (var15?p_78578_7_:1.0F) * 0.6F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
         ...
         this.field_78665_ay *= var23;
         this.field_78652_aC *= var23;
         var24 = p_78578_1_.func_71895_b(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 4);
         if(var9) {
            var24 = this.fixAoSideGrassTexture(var24, p_78578_2_, p_78578_3_, p_78578_4_, 4, p_78578_5_, p_78578_6_, p_78578_7_);
         }

         this.func_78573_e(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var24);
         if(var8 && field_78667_b && var24 == 3 && this.field_78664_d < 0) {
            this.field_78674_ar *= p_78578_5_;
            this.field_78672_as *= p_78578_5_;
            this.field_78670_at *= p_78578_5_;
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_, 5)) {
         ...
         if(this.field_78698_am > 0) {
            ...
            this.field_78628_A = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_);
            this.field_78631_L = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1);
            this.field_78633_N = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1);
            this.field_78634_H = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_);
            ...
            if(!this.field_78646_aM && !this.field_78642_aK) {
               ...
               this.field_78708_z = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_ - 1);
            ...
            if(!this.field_78646_aM && !this.field_78638_aI) {
               ...
               this.field_78629_B = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ - 1, p_78578_4_ + 1);
            ...
            if(!this.field_78654_aE && !this.field_78642_aK) {
               ...
               this.field_78627_G = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_ - 1);
            ...
            if(!this.field_78654_aE && !this.field_78638_aI) {
               ...
               this.field_78636_J = this.getAmbientOcclusionLightValue(this.field_78669_a, p_78578_2_, p_78578_3_ + 1, p_78578_4_ + 1);
            ...
            var20 = (this.field_78628_A + this.field_78629_B + this.field_78697_r + this.field_78633_N) / 4.0F;
            var23 = (this.field_78697_r + this.field_78633_N + this.field_78634_H + this.field_78636_J) / 4.0F;
            var22 = (this.field_78631_L + this.field_78697_r + this.field_78627_G + this.field_78634_H) / 4.0F;
            var21 = (this.field_78708_z + this.field_78628_A + this.field_78631_L + this.field_78697_r) / 4.0F;
            this.field_78700_an = this.func_78602_a(this.field_78655_Y, this.field_78660_Z, this.field_78688_al, var19);
            this.field_78676_aq = this.func_78602_a(this.field_78688_al, this.field_78711_af, this.field_78707_ah, var19);
            this.field_78696_ap = this.func_78602_a(this.field_78692_aj, this.field_78709_ae, this.field_78711_af, var19);
            this.field_78694_ao = this.func_78602_a(this.field_78657_X, this.field_78655_Y, this.field_78692_aj, var19);
         } else {
            var23 = this.field_78697_r;
            var22 = this.field_78697_r;
            var21 = this.field_78697_r;
            var20 = this.field_78697_r;
            this.field_78700_an = this.field_78694_ao = this.field_78696_ap = this.field_78676_aq = var19;
         }

         this.field_78674_ar = this.field_78672_as = this.field_78670_at = this.field_78684_au = (var16?p_78578_5_:1.0F) * 0.6F;
         this.field_78682_av = this.field_78680_aw = this.field_78678_ax = this.field_78665_ay = (var16?p_78578_6_:1.0F) * 0.6F;
         this.field_78663_az = this.field_78650_aA = this.field_78651_aB = this.field_78652_aC = (var16?p_78578_7_:1.0F) * 0.6F;
         this.field_78674_ar *= var20;
         this.field_78682_av *= var20;
         this.field_78663_az *= var20;
         this.field_78672_as *= var21;
         ...
         this.field_78665_ay *= var23;
         this.field_78652_aC *= var23;
         var24 = p_78578_1_.func_71895_b(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 5);
         if(var9) {
            var24 = this.fixAoSideGrassTexture(var24, p_78578_2_, p_78578_3_, p_78578_4_, 5, p_78578_5_, p_78578_6_, p_78578_7_);
         }

         this.func_78605_f(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var24);
         if(var8 && field_78667_b && var24 == 3 && this.field_78664_d < 0) {
            this.field_78674_ar *= p_78578_5_;
            this.field_78672_as *= p_78578_5_;
            this.field_78670_at *= p_78578_5_;
   ...
   public boolean func_78609_c(Block p_78609_1_, int p_78609_2_, int p_78609_3_, int p_78609_4_, float p_78609_5_, float p_78609_6_, float p_78609_7_) {
      ...
      float var14 = 0.8F;
      float var15 = 0.6F;
      float var16 = var13 * p_78609_5_;
      float var17 = var13 * p_78609_6_;
      float var18 = var13 * p_78609_7_;
      float var19 = var12;
      float var20 = var14;
      float var21 = var15;
      float var22 = var12;
      ...
      if(p_78609_1_ != Block.field_71980_u) {
         var19 = var12 * p_78609_5_;
         var20 = var14 * p_78609_5_;
         var21 = var15 * p_78609_5_;
         var22 = var12 * p_78609_6_;
         var23 = var14 * p_78609_6_;
         var24 = var15 * p_78609_6_;
         var25 = var12 * p_78609_7_;
         var26 = var14 * p_78609_7_;
         var27 = var15 * p_78609_7_;
      }

      int var28 = p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_);
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_, p_78609_3_ - 1, p_78609_4_, 0)) {
         var10.func_78380_c(this.field_83027_i <= 0.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_, p_78609_3_ - 1, p_78609_4_):var28);
         var10.func_78386_a(var19, var22, var25);
      ...
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_, p_78609_3_ + 1, p_78609_4_, 1)) {
         var10.func_78380_c(this.field_83024_j >= 1.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_, p_78609_3_ + 1, p_78609_4_):var28);
         var10.func_78386_a(var16, var17, var18);
      ...
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_ - 1, 2)) {
         var10.func_78380_c(this.field_83025_k <= 0.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_ - 1):var28);
         var10.func_78386_a(var20, var23, var26);
         var29 = p_78609_1_.func_71895_b(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 2);
         if(var9) {
            if(var29 == 3 || var29 == 77) {
               var29 = Config.getSideGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 2, var29);
               if(var29 == 0) {
                  var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
               }
            }

            if(var29 == 68) {
               var29 = Config.getSideSnowGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 2);
            }
         }

         this.func_78611_c(p_78609_1_, (double)p_78609_2_, (double)p_78609_3_, (double)p_78609_4_, var29);
         if(var8 && field_78667_b && var29 == 3 && this.field_78664_d < 0) {
            var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
      ...
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_ + 1, 3)) {
         var10.func_78380_c(this.field_83022_l >= 1.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_ + 1):var28);
         var10.func_78386_a(var20, var23, var26);
         var29 = p_78609_1_.func_71895_b(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 3);
         if(var9) {
            if(var29 == 3 || var29 == 77) {
               var29 = Config.getSideGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 3, var29);
               if(var29 == 0) {
                  var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
               }
            }
            ...
            if(var29 == 68) {
               var29 = Config.getSideSnowGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 3);
            }
         }

         this.func_78622_d(p_78609_1_, (double)p_78609_2_, (double)p_78609_3_, (double)p_78609_4_, var29);
         if(var8 && field_78667_b && var29 == 3 && this.field_78664_d < 0) {
            var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
      ...
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_ - 1, p_78609_3_, p_78609_4_, 4)) {
         var10.func_78380_c(this.field_83021_g <= 0.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_ - 1, p_78609_3_, p_78609_4_):var28);
         var10.func_78386_a(var21, var24, var27);
         var29 = p_78609_1_.func_71895_b(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 4);
         if(var9) {
            if(var29 == 3 || var29 == 77) {
               var29 = Config.getSideGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 4, var29);
               if(var29 == 0) {
                  var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
               }
            }
            ...
            if(var29 == 68) {
               var29 = Config.getSideSnowGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 4);
            }
         }

         this.func_78573_e(p_78609_1_, (double)p_78609_2_, (double)p_78609_3_, (double)p_78609_4_, var29);
         if(var8 && field_78667_b && var29 == 3 && this.field_78664_d < 0) {
            var10.func_78386_a(var21 * p_78609_5_, var24 * p_78609_6_, var27 * p_78609_7_);
      ...
      if(this.field_78661_f || p_78609_1_.func_71877_c(this.field_78669_a, p_78609_2_ + 1, p_78609_3_, p_78609_4_, 5)) {
         var10.func_78380_c(this.field_83026_h >= 1.0D?p_78609_1_.func_71874_e(this.field_78669_a, p_78609_2_ + 1, p_78609_3_, p_78609_4_):var28);
         var10.func_78386_a(var21, var24, var27);
         var29 = p_78609_1_.func_71895_b(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 5);
         if(var9) {
            if(var29 == 3 || var29 == 77) {
               var29 = Config.getSideGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 5, var29);
               if(var29 == 0) {
                  var10.func_78386_a(var20 * p_78609_5_, var23 * p_78609_6_, var26 * p_78609_7_);
               }
            }
            ...
            if(var29 == 68) {
               var29 = Config.getSideSnowGrassTexture(this.field_78669_a, p_78609_2_, p_78609_3_, p_78609_4_, 5);
            }
         }

         this.func_78605_f(p_78609_1_, (double)p_78609_2_, (double)p_78609_3_, (double)p_78609_4_, var29);
         if(var8 && field_78667_b && var29 == 3 && this.field_78664_d < 0) {
            var10.func_78386_a(var21 * p_78609_5_, var24 * p_78609_6_, var27 * p_78609_7_);
   ...
   public boolean func_78582_a(BlockFence p_78582_1_, int p_78582_2_, int p_78582_3_, int p_78582_4_) {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78582_2_, p_78582_3_, p_78582_4_)) {
         this.renderSnow(p_78582_2_, p_78582_3_, p_78582_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_82779_a(BlockWall p_82779_1_, int p_82779_2_, int p_82779_3_, int p_82779_4_) {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_82779_2_, p_82779_3_, p_82779_4_)) {
         this.renderSnow(p_82779_2_, p_82779_3_, p_82779_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_78580_a(BlockFenceGate p_78580_1_, int p_78580_2_, int p_78580_3_, int p_78580_4_) {
      ...
      if(Config.isBetterSnow() && this.hasSnowNeighbours(p_78580_2_, p_78580_3_, p_78580_4_)) {
         this.renderSnow(p_78580_2_, p_78580_3_, p_78580_4_, Block.field_72037_aS.field_72022_cl);
      }
   ...
   public boolean func_78601_u(Block p_78601_1_, int p_78601_2_, int p_78601_3_, int p_78601_4_) {
      ...
      var5.func_78386_a(var9, var9, var9);
      int var12 = p_78601_1_.func_71895_b(this.field_78669_a, p_78601_2_, p_78601_3_, p_78601_4_, 2);
      if(var12 < 0) {
         this.field_78666_e = true;
         var12 = -var12;
      }

      this.func_78611_c(p_78601_1_, (double)p_78601_2_, (double)p_78601_3_, (double)p_78601_4_, var12);
      var6 = true;
      this.field_78666_e = false;
      ...
      var5.func_78386_a(var9, var9, var9);
      var12 = p_78601_1_.func_71895_b(this.field_78669_a, p_78601_2_, p_78601_3_, p_78601_4_, 3);
      if(var12 < 0) {
         this.field_78666_e = true;
         var12 = -var12;
      }

      this.func_78622_d(p_78601_1_, (double)p_78601_2_, (double)p_78601_3_, (double)p_78601_4_, var12);
      var6 = true;
      this.field_78666_e = false;
      ...
      var5.func_78386_a(var10, var10, var10);
      var12 = p_78601_1_.func_71895_b(this.field_78669_a, p_78601_2_, p_78601_3_, p_78601_4_, 4);
      if(var12 < 0) {
         this.field_78666_e = true;
         var12 = -var12;
      }

      this.func_78573_e(p_78601_1_, (double)p_78601_2_, (double)p_78601_3_, (double)p_78601_4_, var12);
      var6 = true;
      this.field_78666_e = false;
      ...
      var5.func_78386_a(var10, var10, var10);
      var12 = p_78601_1_.func_71895_b(this.field_78669_a, p_78601_2_, p_78601_3_, p_78601_4_, 5);
      if(var12 < 0) {
         this.field_78666_e = true;
         var12 = -var12;
      }

      this.func_78605_f(p_78601_1_, (double)p_78601_2_, (double)p_78601_3_, (double)p_78601_4_, var12);
      var6 = true;
      this.field_78666_e = false;
      return var6;
   }
   ...
   public void func_78613_a(Block p_78613_1_, double p_78613_2_, double p_78613_4_, double p_78613_6_, int p_78613_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78675_l == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78613_1_, (int)p_78613_2_, (int)p_78613_4_, (int)p_78613_6_, 0, p_78613_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78613_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78675_l == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78613_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78613_2_, (int)p_78613_4_, (int)p_78613_6_, 0);
            if(var47.rotation > 1) {
               this.field_78675_l = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78675_l = this.field_78675_l / 2 * 3;
            }

            if(var47.flip) {
               this.field_78666_e = (var12 & 4) != 0;
            }
      ...
      double var49 = this.field_83021_g;
      double var13 = this.field_83026_h;
      double var15 = this.field_83025_k;
      double var17 = this.field_83022_l;
      ...
      int var19 = (p_78613_8_ & 15) << 4;
      int var20 = p_78613_8_ & 240;
      ...
      var37 = p_78613_2_ + this.field_83021_g;
      double var39 = p_78613_2_ + this.field_83026_h;
      double var41 = p_78613_4_ + this.field_83027_i;
      double var43 = p_78613_6_ + this.field_83025_k;
      double var45 = p_78613_6_ + this.field_83022_l;
   ...
   public void func_78617_b(Block p_78617_1_, double p_78617_2_, double p_78617_4_, double p_78617_6_, int p_78617_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78681_k == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78617_1_, (int)p_78617_2_, (int)p_78617_4_, (int)p_78617_6_, 1, p_78617_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78617_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78681_k == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78617_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78617_2_, (int)p_78617_4_, (int)p_78617_6_, 1);
            if(var47.rotation > 1) {
               this.field_78681_k = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78681_k = this.field_78681_k / 2 * 3;
            }
      ...
      int var19 = (p_78617_8_ & 15) << 4;
      int var20 = p_78617_8_ & 240;
      double var21 = ((double)var19 + var49 * 16.0D) / 256.0D;
      double var23 = ((double)var19 + var13 * 16.0D - 0.01D) / 256.0D;
      double var25 = ((double)var20 + var15 * 16.0D) / 256.0D;
      double var27 = ((double)var20 + var17 * 16.0D - 0.01D) / 256.0D;
      ...
      var37 = p_78617_2_ + this.field_83021_g;
      double var39 = p_78617_2_ + this.field_83026_h;
      double var41 = p_78617_4_ + this.field_83024_j;
      double var43 = p_78617_6_ + this.field_83025_k;
      double var45 = p_78617_6_ + this.field_83022_l;
      if(this.field_78677_m) {
         var9.func_78386_a(this.field_78674_ar, this.field_78682_av, this.field_78663_az);
         var9.func_78380_c(this.field_78700_an);
         var9.func_78374_a(var39, var41, var45, var23, var27);
   ...
   public void func_78611_c(Block p_78611_1_, double p_78611_2_, double p_78611_4_, double p_78611_6_, int p_78611_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78662_g == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78611_1_, (int)p_78611_2_, (int)p_78611_4_, (int)p_78611_6_, 2, p_78611_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78611_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78662_g == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78611_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78611_2_, (int)p_78611_4_, (int)p_78611_6_, 2);
            if(var47.rotation > 1) {
               this.field_78662_g = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78662_g = this.field_78662_g / 2 * 3;
            }
      ...
      double var49 = this.field_83021_g;
      double var13 = this.field_83026_h;
      double var15 = this.field_83027_i;
      double var17 = this.field_83024_j;
      if(var49 < 0.0D || var13 > 1.0D) {
         var49 = 0.0D;
         var13 = 1.0D;
      }
      ...
      int var19 = (p_78611_8_ & 15) << 4;
      int var20 = p_78611_8_ & 240;
      double var21 = ((double)var19 + var49 * 16.0D) / 256.0D;
      double var23 = ((double)var19 + var13 * 16.0D - 0.01D) / 256.0D;
      ...
      var37 = p_78611_2_ + this.field_83021_g;
      double var39 = p_78611_2_ + this.field_83026_h;
      double var41 = p_78611_4_ + this.field_83027_i;
      double var43 = p_78611_4_ + this.field_83024_j;
      double var45 = p_78611_6_ + this.field_83025_k;
      if(this.field_78677_m) {
         var9.func_78386_a(this.field_78674_ar, this.field_78682_av, this.field_78663_az);
         var9.func_78380_c(this.field_78700_an);
         var9.func_78374_a(var37, var43, var45, var29, var33);
         var9.func_78386_a(this.field_78672_as, this.field_78680_aw, this.field_78650_aA);
         var9.func_78380_c(this.field_78694_ao);
         var9.func_78374_a(var39, var43, var45, var21, var25);
         var9.func_78386_a(this.field_78670_at, this.field_78678_ax, this.field_78651_aB);
         var9.func_78380_c(this.field_78696_ap);
         var9.func_78374_a(var39, var41, var45, var31, var35);
         var9.func_78386_a(this.field_78684_au, this.field_78665_ay, this.field_78652_aC);
         var9.func_78380_c(this.field_78676_aq);
         var9.func_78374_a(var37, var41, var45, var23, var27);
      } else {
         var9.func_78374_a(var37, var43, var45, var29, var33);
         var9.func_78374_a(var39, var43, var45, var21, var25);
         var9.func_78374_a(var39, var41, var45, var31, var35);
   ...
   public void func_78622_d(Block p_78622_1_, double p_78622_2_, double p_78622_4_, double p_78622_6_, int p_78622_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78683_h == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78622_1_, (int)p_78622_2_, (int)p_78622_4_, (int)p_78622_6_, 3, p_78622_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78622_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78683_h == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78622_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78622_2_, (int)p_78622_4_, (int)p_78622_6_, 3);
            if(var47.rotation > 1) {
               this.field_78683_h = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78683_h = this.field_78683_h / 2 * 3;
            }
      ...
      int var19 = (p_78622_8_ & 15) << 4;
      int var20 = p_78622_8_ & 240;
      double var21 = ((double)var19 + var49 * 16.0D) / 256.0D;
      double var23 = ((double)var19 + var13 * 16.0D - 0.01D) / 256.0D;
      double var25 = ((double)(var20 + 16) - var17 * 16.0D) / 256.0D;
      double var27 = ((double)(var20 + 16) - var15 * 16.0D - 0.01D) / 256.0D;
      ...
      var37 = p_78622_2_ + this.field_83021_g;
      double var39 = p_78622_2_ + this.field_83026_h;
      double var41 = p_78622_4_ + this.field_83027_i;
      double var43 = p_78622_4_ + this.field_83024_j;
      double var45 = p_78622_6_ + this.field_83022_l;
      if(this.field_78677_m) {
         var9.func_78386_a(this.field_78674_ar, this.field_78682_av, this.field_78663_az);
         var9.func_78380_c(this.field_78700_an);
         var9.func_78374_a(var37, var43, var45, var21, var25);
         var9.func_78386_a(this.field_78672_as, this.field_78680_aw, this.field_78650_aA);
         var9.func_78380_c(this.field_78694_ao);
         var9.func_78374_a(var37, var41, var45, var31, var35);
         var9.func_78386_a(this.field_78670_at, this.field_78678_ax, this.field_78651_aB);
         ...
         var9.func_78386_a(this.field_78684_au, this.field_78665_ay, this.field_78652_aC);
         var9.func_78380_c(this.field_78676_aq);
         var9.func_78374_a(var39, var43, var45, var29, var33);
      } else {
         var9.func_78374_a(var37, var43, var45, var21, var25);
         var9.func_78374_a(var37, var41, var45, var31, var35);
         var9.func_78374_a(var39, var41, var45, var23, var27);
   ...
   public void func_78573_e(Block p_78573_1_, double p_78573_2_, double p_78573_4_, double p_78573_6_, int p_78573_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78679_j == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78573_1_, (int)p_78573_2_, (int)p_78573_4_, (int)p_78573_6_, 4, p_78573_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78573_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78679_j == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78573_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78573_2_, (int)p_78573_4_, (int)p_78573_6_, 4);
            if(var47.rotation > 1) {
               this.field_78679_j = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78679_j = this.field_78679_j / 2 * 3;
            }
      ...
      double var49 = this.field_83025_k;
      double var13 = this.field_83022_l;
      double var15 = this.field_83027_i;
      double var17 = this.field_83024_j;
      if(var49 < 0.0D || var13 > 1.0D) {
         var49 = 0.0D;
      ...
      int var19 = (p_78573_8_ & 15) << 4;
      int var20 = p_78573_8_ & 240;
      double var21 = ((double)var19 + var49 * 16.0D) / 256.0D;
      double var23 = ((double)var19 + var13 * 16.0D - 0.01D) / 256.0D;
      double var25 = ((double)(var20 + 16) - var17 * 16.0D) / 256.0D;
      double var27 = ((double)(var20 + 16) - var15 * 16.0D - 0.01D) / 256.0D;
      ...
      var37 = p_78573_2_ + this.field_83021_g;
      double var39 = p_78573_4_ + this.field_83027_i;
      double var41 = p_78573_4_ + this.field_83024_j;
      double var43 = p_78573_6_ + this.field_83025_k;
      double var45 = p_78573_6_ + this.field_83022_l;
      if(this.field_78677_m) {
         var9.func_78386_a(this.field_78674_ar, this.field_78682_av, this.field_78663_az);
         var9.func_78380_c(this.field_78700_an);
         var9.func_78374_a(var37, var41, var45, var29, var33);
         var9.func_78386_a(this.field_78672_as, this.field_78680_aw, this.field_78650_aA);
         var9.func_78380_c(this.field_78694_ao);
         var9.func_78374_a(var37, var41, var43, var21, var25);
         var9.func_78386_a(this.field_78670_at, this.field_78678_ax, this.field_78651_aB);
         var9.func_78380_c(this.field_78696_ap);
         var9.func_78374_a(var37, var39, var43, var31, var35);
         var9.func_78386_a(this.field_78684_au, this.field_78665_ay, this.field_78652_aC);
         var9.func_78380_c(this.field_78676_aq);
         var9.func_78374_a(var37, var39, var45, var23, var27);
      } else {
         var9.func_78374_a(var37, var41, var45, var29, var33);
         var9.func_78374_a(var37, var41, var43, var21, var25);
         var9.func_78374_a(var37, var39, var43, var31, var35);
   ...
   public void func_78605_f(Block p_78605_1_, double p_78605_2_, double p_78605_4_, double p_78605_6_, int p_78605_8_) {
      ...
      if(Config.isConnectedTextures() && this.field_78664_d < 0 && this.field_78685_i == 0) {
         int var10 = ConnectedTextures.getConnectedTexture(this.field_78669_a, p_78605_1_, (int)p_78605_2_, (int)p_78605_4_, (int)p_78605_6_, 5, p_78605_8_);
         if(var10 >= 0) {
            int var11 = var10 / 256;
            var9 = Tessellator.field_78398_a.getSubTessellator(var11);
            p_78605_8_ = var10 % 256;
         }
      }

      boolean var48 = false;
      if(Config.isNaturalTextures() && this.field_78664_d < 0 && this.field_78685_i == 0) {
         NaturalProperties var47 = NaturalTextures.getNaturalProperties(var9.textureID, p_78605_8_);
         if(var47 != null) {
            int var12 = Config.getRandom((int)p_78605_2_, (int)p_78605_4_, (int)p_78605_6_, 5);
            if(var47.rotation > 1) {
               this.field_78685_i = var12 & 3;
            }

            if(var47.rotation == 2) {
               this.field_78685_i = this.field_78685_i / 2 * 3;
            }
      ...
      int var19 = (p_78605_8_ & 15) << 4;
      int var20 = p_78605_8_ & 240;
      double var21 = ((double)var19 + var49 * 16.0D) / 256.0D;
      double var23 = ((double)var19 + var13 * 16.0D - 0.01D) / 256.0D;
      double var25 = ((double)(var20 + 16) - var17 * 16.0D) / 256.0D;
      double var27 = ((double)(var20 + 16) - var15 * 16.0D - 0.01D) / 256.0D;
      ...
      var37 = p_78605_2_ + this.field_83026_h;
      double var39 = p_78605_4_ + this.field_83027_i;
      double var41 = p_78605_4_ + this.field_83024_j;
      double var43 = p_78605_6_ + this.field_83025_k;
      double var45 = p_78605_6_ + this.field_83022_l;
      if(this.field_78677_m) {
         var9.func_78386_a(this.field_78674_ar, this.field_78682_av, this.field_78663_az);
         var9.func_78380_c(this.field_78700_an);
         var9.func_78374_a(var37, var39, var45, var31, var35);
         var9.func_78386_a(this.field_78672_as, this.field_78680_aw, this.field_78650_aA);
         var9.func_78380_c(this.field_78694_ao);
         var9.func_78374_a(var37, var39, var43, var23, var27);
         var9.func_78386_a(this.field_78670_at, this.field_78678_ax, this.field_78651_aB);
         var9.func_78380_c(this.field_78696_ap);
         var9.func_78374_a(var37, var41, var43, var29, var33);
         var9.func_78386_a(this.field_78684_au, this.field_78665_ay, this.field_78652_aC);
         var9.func_78380_c(this.field_78676_aq);
         var9.func_78374_a(var37, var41, var45, var21, var25);
      } else {
         var9.func_78374_a(var37, var39, var45, var31, var35);
         var9.func_78374_a(var37, var39, var43, var23, var27);
         var9.func_78374_a(var37, var41, var43, var29, var33);
   ...
   public void func_78600_a(Block p_78600_1_, int p_78600_2_, float p_78600_3_) {
      ...
      if(var6 != 0 && var6 != 31 && var6 != 16 && var6 != 26) {
         if(var6 == 1) {
            ...
            Reflector.callVoid(Reflector.ModLoader_renderInvBlock, new Object[]{this, p_78600_1_, Integer.valueOf(p_78600_2_), Integer.valueOf(var6)});
         }
      } else {
         if(var6 == 16) {
            p_78600_2_ = 1;
   ...
   public static boolean func_78597_b(int p_78597_0_) {
      ...
      default:
         if(Reflector.ModLoader.exists()) {
            return Reflector.callBoolean(Reflector.ModLoader_renderBlockIsItemFull3D, new Object[]{Integer.valueOf(p_78597_0_)});
         }
   ...
   public boolean func_78612_b(Block p_78612_1_, int p_78612_2_, int p_78612_3_, int p_78612_4_) {
      ...
      if(Config.isBetterSnow() && p_78612_1_ == Block.field_72053_aD && this.hasSnowNeighbours(p_78612_2_, p_78612_3_, p_78612_4_)) {
         this.renderSnow(p_78612_2_, p_78612_3_, p_78612_4_, Block.field_72037_aS.field_72022_cl);
      }
      ...
      default:
         if(Reflector.ModLoader.exists()) {
            return Reflector.callBoolean(Reflector.ModLoader_renderWorldBlock, new Object[]{this, this.field_78669_a, Integer.valueOf(p_78612_2_), Integer.valueOf(p_78612_3_), Integer.valueOf(p_78612_4_), p_78612_1_, Integer.valueOf(var5)});
         }
   ...
   private void calculateAoLightValues(Block var1, int var2, int var3, int var4) {
      this.field_78673_o = this.getAmbientOcclusionLightValue(this.field_78669_a, var2 - 1, var3, var4);
      this.field_78701_p = this.getAmbientOcclusionLightValue(this.field_78669_a, var2, var3 - 1, var4);
      this.field_78699_q = this.getAmbientOcclusionLightValue(this.field_78669_a, var2, var3, var4 - 1);
      this.field_78697_r = this.getAmbientOcclusionLightValue(this.field_78669_a, var2 + 1, var3, var4);
      this.field_78695_s = this.getAmbientOcclusionLightValue(this.field_78669_a, var2, var3 + 1, var4);
      this.field_78693_t = this.getAmbientOcclusionLightValue(this.field_78669_a, var2, var3, var4 + 1);
      this.field_78654_aE = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 + 1, var3 + 1, var4)];
      this.field_78646_aM = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 + 1, var3 - 1, var4)];
      this.field_78638_aI = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 + 1, var3, var4 + 1)];
      this.field_78642_aK = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 + 1, var3, var4 - 1)];
      this.field_78656_aF = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 - 1, var3 + 1, var4)];
      this.field_78647_aN = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 - 1, var3 - 1, var4)];
      this.field_78659_aH = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 - 1, var3, var4 - 1)];
      this.field_78640_aJ = Block.field_71985_p[this.field_78669_a.func_72798_a(var2 - 1, var3, var4 + 1)];
      this.field_78658_aG = Block.field_71985_p[this.field_78669_a.func_72798_a(var2, var3 + 1, var4 + 1)];
      this.field_78653_aD = Block.field_71985_p[this.field_78669_a.func_72798_a(var2, var3 + 1, var4 - 1)];
      this.field_78648_aO = Block.field_71985_p[this.field_78669_a.func_72798_a(var2, var3 - 1, var4 + 1)];
      this.field_78644_aL = Block.field_71985_p[this.field_78669_a.func_72798_a(var2, var3 - 1, var4 - 1)];
   ...
   private float getAmbientOcclusionLightValue(IBlockAccess var1, int var2, int var3, int var4) {
      Block var5 = Block.field_71973_m[var1.func_72798_a(var2, var3, var4)];
      return var5 == null?1.0F:(var5.getClass() == BlockGlass.class?1.0F:(var5.field_72018_cp.func_76230_c() && var5.func_71886_c()?this.aoLightValueOpaque:1.0F));
   }

   private int fixAoSideGrassTexture(int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8) {
      if(var1 == 3 || var1 == 77) {
         var1 = Config.getSideGrassTexture(this.field_78669_a, var2, var3, var4, var5, var1);
         if(var1 == 0) {
            this.field_78674_ar *= var6;
            this.field_78672_as *= var6;
            this.field_78670_at *= var6;
            this.field_78684_au *= var6;
            this.field_78682_av *= var7;
            this.field_78680_aw *= var7;
            this.field_78678_ax *= var7;
            this.field_78665_ay *= var7;
            this.field_78663_az *= var8;
            this.field_78650_aA *= var8;
            this.field_78651_aB *= var8;
            this.field_78652_aC *= var8;
         }
      }

      if(var1 == 68) {
         var1 = Config.getSideSnowGrassTexture(this.field_78669_a, var2, var3, var4, var5);
      }
   ...
   private boolean hasSnowNeighbours(int var1, int var2, int var3) {
      int var4 = Block.field_72037_aS.field_71990_ca;
      return this.field_78669_a.func_72798_a(var1 - 1, var2, var3) != var4 && this.field_78669_a.func_72798_a(var1 + 1, var2, var3) != var4 && this.field_78669_a.func_72798_a(var1, var2, var3 - 1) != var4 && this.field_78669_a.func_72798_a(var1, var2, var3 + 1) != var4?false:this.field_78669_a.func_72804_r(var1, var2 - 1, var3);
   }

   private void renderSnow(int var1, int var2, int var3, double var4) {
      this.func_83018_a(Block.field_72037_aS);
      this.field_83024_j = var4;
      this.func_78570_q(Block.field_72037_aS, var1, var2, var3);
   }
