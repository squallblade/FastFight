...
class PlayerInstance {
   ...
   public PlayerInstance(PlayerManager p_i3391_1_, int p_i3391_2_, int p_i3391_3_) {
      this(p_i3391_1_, p_i3391_2_, p_i3391_3_, false);
   }
   ...
   public PlayerInstance(PlayerManager var1, int var2, int var3, boolean var4) {
      ...
      if(var5 && !var1.func_72688_a().field_73059_b.func_73149_a(var2, var3)) {
         this.field_73265_a.chunkCoordsNotLoaded.add(this.field_73264_c);
         this.chunkLoaded = false;
      } else {
   ...
   public void func_73252_b(EntityPlayerMP p_73252_1_) {
      this.sendThisChunkToPlayer(p_73252_1_, true);
   }

   public void sendThisChunkToPlayer(EntityPlayerMP var1, boolean var2) {
      if(this.field_73263_b.contains(var1)) {
         if(var2) {
            var1.field_71135_a.func_72567_b(new Packet51MapChunk(PlayerManager.func_72692_a(this.field_73265_a).func_72964_e(this.field_73264_c.field_77276_a, this.field_73264_c.field_77275_b), true, 0));
         }

         this.field_73263_b.remove(var1);
         var1.field_71129_f.remove(this.field_73264_c);
         if(Reflector.EventBus.exists()) {
            Reflector.postForgeBusEvent(Reflector.ChunkWatchEvent_UnWatch_Constructor, new Object[]{this.field_73264_c, var1});
         }
            ...
            if(this.field_73262_e == 64) {
               ...
               for(var3 = 0; var3 < 16; ++var3) {
                  if((this.field_73260_f & 1 << var3) != 0) {
                     var4 = var3 << 4;
                     List var5 = PlayerManager.func_72692_a(this.field_73265_a).func_73049_a(var1, var4, var2, var1 + 16, var4 + 16, var2 + 15);
   ...
   public void sendThisChunkToAllPlayers() {
      for(int var1 = 0; var1 < this.field_73263_b.size(); ++var1) {
         EntityPlayerMP var2 = (EntityPlayerMP)this.field_73263_b.get(var1);
         Chunk var3 = PlayerManager.func_72692_a(this.field_73265_a).func_72964_e(this.field_73264_c.field_77276_a, this.field_73264_c.field_77275_b);
         ArrayList var4 = new ArrayList(1);
         var4.add(var3);
         var2.field_71135_a.func_72567_b(new Packet56MapChunks(var4));
      }
