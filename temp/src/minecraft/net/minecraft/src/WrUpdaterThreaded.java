...
public class WrUpdaterThreaded implements IWrUpdater {
   ...
   public boolean updateRenderers(RenderGlobal var1, EntityLiving var2, boolean var3) {
      ...
      if(var1.field_72767_j.size() <= 0) {
         ...
         int var10;
         float var12;
         for(var10 = 0; var10 < var1.field_72767_j.size(); ++var10) {
            WorldRenderer var11 = (WorldRenderer)var1.field_72767_j.get(var10);
            if(var11 != null) {
               ++var6;
               if(!var11.isUpdating) {
                  if(!var11.field_78939_q) {
                     var1.field_72767_j.set(var10, (Object)null);
                  } else {
                     var12 = var11.func_78912_a(var2);
                     if(var12 < 512.0F) {
                        if(var12 < 256.0F && var1.isActingNow() && var11.field_78927_l || this.firstUpdate) {
                           if(this.updateThread != null) {
                              this.updateThread.unpauseToEndOfUpdate();
                           }
         ...
         if(var7 != null) {
            ...
            var1.field_72767_j.set(var9, (Object)null);
            ++var4;
            var12 = var8 / 5.0F;

            for(var13 = 0; var13 < var1.field_72767_j.size() && var4 < var10; ++var13) {
               WorldRenderer var14 = (WorldRenderer)var1.field_72767_j.get(var13);
               if(var14 != null && !var14.isUpdating) {
                  float var15 = var14.func_78912_a(var2);
                  if(!var14.field_78927_l) {
                     var15 *= (float)var5;
                  }
                  ...
                  if(var16 < var12) {
                     ...
                     var1.field_72767_j.set(var13, (Object)null);
                     ++var4;
                  }
               }
            }
         ...
         if(var6 == 0) {
            var1.field_72767_j.clear();
         }

         if(var1.field_72767_j.size() > 100 && var6 < var1.field_72767_j.size() * 4 / 5) {
            int var18 = 0;

            for(var13 = 0; var13 < var1.field_72767_j.size(); ++var13) {
               Object var19 = var1.field_72767_j.get(var13);
               if(var19 != null) {
                  if(var13 != var18) {
                     var1.field_72767_j.set(var18, var19);
                  }
            ...
            for(var13 = var1.field_72767_j.size() - 1; var13 >= var18; --var13) {
               var1.field_72767_j.remove(var13);
            }
         }
