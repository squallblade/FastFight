...
public class WrUpdateThread extends Thread {
   ...
   public WrUpdateThread(Pbuffer var1) {
      ...
      this.mainTessellator = Tessellator.field_78398_a;
      ...
      while(!Thread.interrupted() && !this.terminated) {
         try {
            ...
            try {
               ...
               Tessellator.field_78398_a = this.threadTessellator;
               var2.updateRenderer(var1);
            } finally {
               Tessellator.field_78398_a = this.mainTessellator;
            }
            ...
            if(this.currentRenderer != null) {
               ...
               this.currentRenderer.field_78939_q = true;
            }
