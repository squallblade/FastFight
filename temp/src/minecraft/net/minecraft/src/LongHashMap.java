...
public class LongHashMap {
   ...
   private transient LongHashMapEntry[] field_76169_a = new LongHashMapEntry[1024];
   private transient int field_76167_b;
   private int field_76168_c;
   private final float field_76165_d;
   private transient volatile int field_76166_e;


   public LongHashMap() {
      this.field_76168_c = (int)(0.75F * (float)this.field_76169_a.length);
      this.field_76165_d = 0.75F;
   }
   ...
   public double getKeyDistribution() {
      ...
      for(int var2 = 0; var2 < this.field_76169_a.length; ++var2) {
         if(this.field_76169_a[var2] != null) {
            ++var1;
         }
      }

      return 1.0D * (double)var1 / (double)this.field_76167_b;
   }
}
