...
public class Config {
   ...
   public static void setGameSettings(GameSettings var0) {
      ...
      gameSettings = var0;
      minecraft = gameSettings.field_74317_L;
   ...
   public static boolean isOcclusionEnabled() {
      return gameSettings == null?DEF_OCCLUSION_ENABLED.booleanValue():gameSettings.field_74349_h;
   }
   ...
   public static void log(String var0) {
      ...
      try {
         if(logFile == null) {
            logFile = new File(Minecraft.func_71380_b(), "optifog.log");
            logFile.delete();
   ...
   public static boolean isRainFancy() {
      return gameSettings.ofRain == 0?gameSettings.field_74347_j:gameSettings.ofRain == 2;
   }

   public static boolean isWaterFancy() {
      return gameSettings.ofWater == 0?gameSettings.field_74347_j:gameSettings.ofWater == 2;
   }
   ...
   public static boolean isCloudsFancy() {
      return gameSettings.ofClouds == 0?gameSettings.field_74347_j:gameSettings.ofClouds == 2;
   }
   ...
   public static boolean isTreesFancy() {
      return gameSettings.ofTrees == 0?gameSettings.field_74347_j:gameSettings.ofTrees == 2;
   }

   public static boolean isGrassFancy() {
      return gameSettings.ofGrass == 0?gameSettings.field_74347_j:gameSettings.ofGrass == 2;
   }

   public static boolean isDroppedItemsFancy() {
      return gameSettings.ofDroppedItems == 0?gameSettings.field_74347_j:gameSettings.ofDroppedItems == 2;
   }
   ...
   public static int getSideGrassTexture(IBlockAccess var0, int var1, int var2, int var3, int var4, int var5) {
      if(!isBetterGrass()) {
         ...
         if(isBetterGrassFancy()) {
            ...
            int var8 = var0.func_72798_a(var1, var2, var3);
            if(var8 != var7) {
               return var5;
            }
         }
   ...
   public static int getSideSnowGrassTexture(IBlockAccess var0, int var1, int var2, int var3, int var4) {
      if(!isBetterGrass()) {
         ...
         if(isBetterGrassFancy()) {
            ...
            int var5 = var0.func_72798_a(var1, var2, var3);
            if(var5 != 78 && var5 != 80) {
               return 68;
            }
         }
   ...
   public static void fixWorldTime(Minecraft var0) {
      WorldClient var1 = var0.field_71441_e;
      if(var1 != null) {
         IntegratedServer var2 = var0.func_71401_C();
         if(var2 != null) {
            WorldInfo var3 = var1.field_72986_A;
            if(var3 != null) {
               if(var3.func_76077_q().func_77148_a() == 1) {
                  WorldProvider var4 = var1.field_73011_w;
                  if(var4 != null) {
                     int var5 = var4.field_76574_g;
                     if(var5 == 0) {
                        WorldServer var6 = var2.func_71218_a(var5);
                        if(var6 != null) {
                           long var7 = var6.func_72820_D();
                           long var9 = var7 % 24000L;
                           if(isTimeDayOnly()) {
                              if(var9 <= 1000L) {
                                 var6.func_72877_b(var7 - var9 + 1001L);
                              }

                              if(var9 >= 11000L) {
                                 var6.func_72877_b(var7 - var9 + 24001L);
                              }
                           }

                           if(isTimeNightOnly()) {
                              if(var9 <= 14000L) {
                                 var6.func_72877_b(var7 - var9 + 14001L);
                              }

                              if(var9 >= 22000L) {
                                 var6.func_72877_b(var7 - var9 + 24000L + 14001L);
                              }
                           }
   ...
   public static WorldServer getWorldServer() {
      if(minecraft == null) {
         ...
         WorldClient var0 = minecraft.field_71441_e;
         if(var0 == null) {
            return null;
         } else {
            WorldProvider var1 = var0.field_73011_w;
            if(var1 == null) {
               return null;
            } else {
               int var2 = var1.field_76574_g;
               IntegratedServer var3 = minecraft.func_71401_C();
               if(var3 == null) {
                  return null;
               } else {
                  WorldServer var4 = var3.func_71218_a(var2);
                  return var4;
               }
            }
         }
