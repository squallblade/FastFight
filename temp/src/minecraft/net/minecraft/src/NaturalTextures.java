...
public class NaturalTextures {
   ...
   public static void update(RenderEngine var0) {
      ...
      if(Config.isNaturalTextures()) {
         ...
         InputStream var2 = var0.field_78366_k.func_77292_e().func_77532_a(var1);
         if(var2 == null) {
                     ...
                     if(var8.length != 2) {
                        ...
                        if(var11.length != 2) {
                           ...
                           if(var14 >= 0 && var14 <= 255) {
                              ...
                              if(var15.isValid()) {
                                 int var16 = var0.func_78341_b(var12);
                                 if(var16 >= 0) {
   ...
   private static NaturalProperties[][] makeDefaultProperties() {
      if(!(renderEngine.field_78366_k.func_77292_e() instanceof TexturePackDefault)) {
