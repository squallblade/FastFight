...
public abstract class EntityLiving extends Entity {
   ...
   public EntityLiving(World p_i3443_1_) {
      super(p_i3443_1_);
      this.persistentId = this.field_70146_Z.nextInt(Integer.MAX_VALUE);
   ...
   public boolean func_70097_a(DamageSource p_70097_1_, int p_70097_2_) {
      if(Reflector.ForgeHooks_onLivingAttack.exists() && Reflector.callBoolean(Reflector.ForgeHooks_onLivingAttack, new Object[]{this, p_70097_1_, Integer.valueOf(p_70097_2_)})) {
         return false;
         ...
         if(this.field_70734_aK <= 0) {
            ...
            if(var3) {
               ...
               if(var4 != null) {
                  ...
                  this.field_70739_aP = (float)(Math.atan2(var7, var9) * 180.0D / 3.141592653589793D) - this.field_70177_z;
   ...
   protected void func_70665_d(DamageSource p_70665_1_, int p_70665_2_) {
      if(!this.func_85032_ar()) {
         if(Reflector.ForgeHooks_onLivingHurt.exists()) {
            p_70665_2_ = Reflector.callInt(Reflector.ForgeHooks_onLivingHurt, new Object[]{this, p_70665_1_, Integer.valueOf(p_70665_2_)});
            if(p_70665_2_ <= 0) {
               return;
            }
         }
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      if(!Reflector.ForgeHooks_onLivingDeath.exists() || !Reflector.callBoolean(Reflector.ForgeHooks_onLivingDeath, new Object[]{this, p_70645_1_})) {
         ...
         if(!this.field_70170_p.field_72995_K) {
            ...
            if(!this.func_70631_g_() && this.field_70170_p.func_82736_K().func_82766_b("doMobLoot")) {
               ...
               if(this.field_70718_bc > 0) {
                  var5 = this.field_70146_Z.nextInt(200) - var3;
                  if(var5 < 5) {
            ...
            if(Reflector.ForgeEntity_captureDrops.exists()) {
               ...
               if(!Reflector.callBoolean(Reflector.ForgeHooks_onLivingDrops, new Object[]{this, p_70645_1_, var4, Integer.valueOf(var3), Boolean.valueOf(this.field_70718_bc > 0), Integer.valueOf(var5)})) {
   ...
   protected void func_70069_a(float p_70069_1_) {
      if(Reflector.ForgeHooks_onLivingFall.exists()) {
         p_70069_1_ = Reflector.callFloat(Reflector.ForgeHooks_onLivingFall, new Object[]{this, Float.valueOf(p_70069_1_)});
         if(p_70069_1_ <= 0.0F) {
            return;
         }
      }
   ...
   public void func_70612_e(float p_70612_1_, float p_70612_2_) {
      ...
      if(this.func_70090_H() && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).field_71075_bZ.field_75100_b)) {
         ...
         if(this.field_70123_F && this.func_70038_c(this.field_70159_w, this.field_70181_x + 0.6000000238418579D - this.field_70163_u + var3, this.field_70179_y)) {
         ...
         if(this.field_70122_E) {
            ...
            if(var6 > 0) {
               var5 = Block.field_71973_m[var6].field_72016_cq * 0.91F;
            }
         }
         ...
         if(this.field_70122_E) {
            if(this.func_70650_aV()) {
               var7 = this.func_70689_ay();
            } else {
               var7 = this.field_70746_aG;
            }

            var7 *= var10;
         } else {
            var7 = this.field_70747_aH;
         }

         this.func_70060_a(p_70612_1_, p_70612_2_, var7);
         var5 = 0.91F;
         if(this.field_70122_E) {
            var5 = 0.54600006F;
            int var8 = this.field_70170_p.func_72798_a(MathHelper.func_76128_c(this.field_70165_t), MathHelper.func_76128_c(this.field_70121_D.field_72338_b) - 1, MathHelper.func_76128_c(this.field_70161_v));
            if(var8 > 0) {
               var5 = Block.field_71973_m[var8].field_72016_cq * 0.91F;
            }
         }

         if(this.func_70617_f_()) {
            float var12 = 0.15F;
            if(this.field_70159_w < (double)(-var12)) {
               this.field_70159_w = (double)(-var12);
            }
            ...
            if(this.field_70179_y < (double)(-var12)) {
               this.field_70179_y = (double)(-var12);
            }
            ...
            boolean var9 = this.func_70093_af() && this instanceof EntityPlayer;
            if(var9 && this.field_70181_x < 0.0D) {
      ...
      var3 = this.field_70165_t - this.field_70169_q;
      double var11 = this.field_70161_v - this.field_70166_s;
      var7 = MathHelper.func_76133_a(var3 * var3 + var11 * var11) * 4.0F;
      if(var7 > 1.0F) {
         var7 = 1.0F;
      }
   ...
   public boolean func_70617_f_() {
      ...
      return Reflector.ForgeHooks_isLivingOnLadder.exists()?Reflector.callBoolean(Reflector.ForgeHooks_isLivingOnLadder, new Object[]{Block.field_71973_m[var4], this.field_70170_p, Integer.valueOf(var1), Integer.valueOf(var2), Integer.valueOf(var3)}):var4 == Block.field_72055_aF.field_71990_ca || var4 == Block.field_71998_bu.field_71990_ca;
   }
   ...
   public void func_70014_b(NBTTagCompound p_70014_1_) {
      ...
      p_70014_1_.func_74768_a("PersistentId", this.persistentId);
   }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.persistentId = p_70037_1_.func_74762_e("PersistentId");
   ...
   public void func_70625_a(Entity p_70625_1_, float p_70625_2_, float p_70625_3_) {
      ...
      double var6 = p_70625_1_.field_70161_v - this.field_70161_v;
      double var8;
      if(p_70625_1_ instanceof EntityLiving) {
         EntityLiving var10 = (EntityLiving)p_70625_1_;
         var8 = this.field_70163_u + (double)this.func_70047_e() - (var10.field_70163_u + (double)var10.func_70047_e());
      } else {
         var8 = (p_70625_1_.field_70121_D.field_72338_b + p_70625_1_.field_70121_D.field_72337_e) / 2.0D - (this.field_70163_u + (double)this.func_70047_e());
      }

      double var14 = (double)MathHelper.func_76133_a(var4 * var4 + var6 * var6);
   ...
   public void curePotionEffects(ItemStack var1) {
      Iterator var2 = this.field_70713_bf.keySet().iterator();
      if(!this.field_70170_p.field_72995_K) {
         while(var2.hasNext()) {
            Integer var3 = (Integer)var2.next();
            PotionEffect var4 = (PotionEffect)this.field_70713_bf.get(var3);
            if(Reflector.callBoolean(var4, Reflector.ForgePotionEffect_isCurativeItem, new Object[]{var1})) {
               var2.remove();
               this.func_70688_c(var4);
            }
         }
