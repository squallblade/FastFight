...
public class CustomColorizer {
   ...
   private static void readColorProperties(String var0, RenderEngine var1) {
      InputStream var2 = var1.getTexturePack().func_77292_e().func_77532_a(var0);
      if(var2 != null) {
         try {
      ...
      for(int var19 = 0; var19 < var18.length; ++var19) {
         ...
         for(int var12 = 0; var12 < var11.length; ++var12) {
            ...
            if(var20 >= 0 && var20 <= 255) {
               if(var20 != Block.field_71980_u.field_71990_ca && var20 != Block.field_71962_X.field_71990_ca && var20 != Block.field_71952_K.field_71990_ca && var20 != Block.field_71998_bu.field_71990_ca) {
                  if(var14 == -1) {
   ...
   private static int[] getCustomColors(String var0, RenderEngine var1, int var2) {
      InputStream var3 = var1.getTexturePack().func_77292_e().func_77532_a(var0);
      if(var3 == null) {
         return null;
      } else {
         int[] var4 = var1.func_78346_a(var0);
         if(var4 == null) {
            return null;
   ...
   public static int getColorMultiplier(Block var0, IBlockAccess var1, int var2, int var3, int var4) {
      if(foliageBirchColors == null && foliagePineColors == null && swampGrassColors == null && swampFoliageColors == null && blockPalettes == null && Config.isSwampColors() && Config.isSmoothBiomes()) {
         return var0.func_71920_b(var1, var2, var3, var4);
      } else {
         int[] var5 = null;
         int[] var6 = null;
         int var10;
         if(blockPalettes != null) {
            int var7 = var0.field_71990_ca;
            if(var7 >= 0 && var7 < 256) {
         ...
         byte var14 = 0;
         var10 = 0;
         if(var0 != Block.field_71980_u && var0 != Block.field_71962_X) {
            if(var0 == Block.field_71952_K) {
               var14 = 2;
            ...
            } else if(var0 == Block.field_71998_bu) {
               var14 = 2;
               var12 = Config.isSmoothBiomes();
               var5 = foliageColors;
               if(var11) {
         ...
         if(var12) {
            ...
            if(var6 != var5 && var1.func_72807_a(var2, var4) == BiomeGenBase.field_76780_h) {
               var5 = var6;
            }

            return var5 != null?getCustomColor(var5, var1, var2, var3, var4):var0.func_71920_b(var1, var2, var3, var4);
         }
      }
   }
   ...
   private static int getSmoothColorMultiplier(Block var0, IBlockAccess var1, int var2, int var3, int var4, int[] var5, int[] var6, int var7, int var8) {
      ...
      for(var12 = var2 - 1; var12 <= var2 + 1; ++var12) {
         for(var13 = var4 - 1; var13 <= var4 + 1; ++var13) {
            int[] var14 = var5;
            if(var6 != var5 && var1.func_72807_a(var12, var13) == BiomeGenBase.field_76780_h) {
               var14 = var6;
            }
            ...
            if(var14 == null) {
               switch(var7) {
               case 1:
                  var17 = var1.func_72807_a(var12, var13).func_76737_k();
                  break;
               case 2:
                  if((var8 & 3) == 1) {
                     var17 = ColorizerFoliage.func_77466_a();
                  } else if((var8 & 3) == 2) {
                     var17 = ColorizerFoliage.func_77469_b();
                  } else {
                     var17 = var1.func_72807_a(var12, var13).func_76726_l();
                  }
                  break;
               default:
                  var17 = var0.func_71920_b(var1, var12, var3, var13);
               }
            } else {
   ...
   public static int getFluidColor(Block var0, IBlockAccess var1, int var2, int var3, int var4) {
      return var0.field_72018_cp != Material.field_76244_g?var0.func_71920_b(var1, var2, var3, var4):(waterColors != null?(Config.isSmoothBiomes()?getSmoothColor(waterColors, var1, (double)var2, (double)var3, (double)var4, 3, 1):getCustomColor(waterColors, var1, var2, var3, var4)):(!Config.isSwampColors()?16777215:var0.func_71920_b(var1, var2, var3, var4)));
   }

   private static int getCustomColor(int[] var0, IBlockAccess var1, int var2, int var3, int var4) {
      BiomeGenBase var5 = var1.func_72807_a(var2, var4);
      double var6 = (double)MathHelper.func_76131_a(var5.func_76743_j(), 0.0F, 1.0F);
      double var8 = (double)MathHelper.func_76131_a(var5.func_76727_i(), 0.0F, 1.0F);
      var8 *= var6;
   ...
   public static void updatePortalFX(EntityFX var0) {
      if(particlePortalColor >= 0) {
         ...
         float var6 = (float)var3 / 255.0F;
         float var7 = (float)var4 / 255.0F;
         var0.field_70552_h = var5;
         var0.field_70553_i = var6;
         var0.field_70551_j = var7;
      }
   }
   ...
   public static void updateReddustFX(EntityFX var0, IBlockAccess var1, double var2, double var4, double var6) {
      if(redstoneColors != null) {
         int var8 = var1.func_72805_g((int)var2, (int)var4, (int)var6);
         ...
         if(var9 != -1) {
            ...
            var0.field_70552_h = var13;
            var0.field_70553_i = var14;
            var0.field_70551_j = var15;
         }
      }
   }
   ...
   public static void updateWaterFX(EntityFX var0, IBlockAccess var1) {
      if(waterColors != null) {
         int var2 = (int)var0.field_70165_t;
         int var3 = (int)var0.field_70163_u;
         int var4 = (int)var0.field_70161_v;
         int var5 = getFluidColor(Block.field_71943_B, var1, var2, var3, var4);
         ...
         var0.field_70552_h = var9;
         var0.field_70553_i = var10;
         var0.field_70551_j = var11;
      }
   }

   public static int getLilypadColor() {
      return lilyPadColor < 0?Block.field_71991_bz.func_71933_m():lilyPadColor;
   }
   ...
   public static Vec3 getSkyColor(Vec3 var0, IBlockAccess var1, double var2, double var4, double var6) {
      if(skyColors == null) {
         ...
         float var13 = (float)var10 / 255.0F;
         float var14 = (float)var11 / 255.0F;
         float var15 = (float)var0.field_72450_a / 0.5F;
         float var16 = (float)var0.field_72448_b / 0.66275F;
         float var17 = (float)var0.field_72449_c;
         var12 *= var15;
         var13 *= var16;
         var14 *= var17;
         return Vec3.func_72443_a((double)var12, (double)var13, (double)var14);
      }
   }
   ...
   public static Vec3 getFogColor(Vec3 var0, IBlockAccess var1, double var2, double var4, double var6) {
      if(fogColors == null) {
         ...
         float var13 = (float)var10 / 255.0F;
         float var14 = (float)var11 / 255.0F;
         float var15 = (float)var0.field_72450_a / 0.753F;
         float var16 = (float)var0.field_72448_b / 0.8471F;
         float var17 = (float)var0.field_72449_c;
         var12 *= var15;
         var13 *= var16;
         var14 *= var17;
   ...
   public static boolean updateLightmap(World var0, EntityRenderer var1, int[] var2, boolean var3) {
      if(var0 == null) {
         ...
         int var4 = var0.field_73011_w.field_76574_g;
         if(var4 >= -1 && var4 <= 1) {
            int var5 = var4 + 1;
            ...
            if(var6 == null) {
               ...
               if(var3 && var7 < 64) {
                  ...
                  if(var8 < 16) {
                     ...
                     float var10 = 1.1666666F * (var0.func_72971_b(1.0F) - 0.2F);
                     if(var0.field_73016_r > 0) {
                        var10 = 1.0F;
                     }

                     var10 = Config.limitTo1(var10);
                     float var11 = var10 * (float)(var8 - 1);
                     float var12 = Config.limitTo1(var1.field_78514_e + 0.5F) * (float)(var8 - 1);
                     float var13 = Config.limitTo1(Config.getMinecraft().field_71474_y.field_74333_Y);
