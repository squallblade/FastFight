...
public class IntegratedServer extends MinecraftServer {
   ...
   protected void func_71247_a(String p_71247_1_, String p_71247_2_, long p_71247_3_, WorldType p_71247_5_, String p_71247_6_) {
      ...
      if(Reflector.DimensionManager.exists()) {
         Object var8 = this.func_71242_L()?new DemoWorldServer(this, var7, p_71247_2_, 0, this.field_71304_b):new WorldServerOF(this, var7, p_71247_2_, 0, this.field_71350_m, this.field_71304_b);
         ...
         for(int var12 = 0; var12 < var11; ++var12) {
            ...
            Object var14 = var13 == 0?var8:new WorldServerMulti(this, var7, p_71247_2_, var13, this.field_71350_m, (WorldServer)var8, this.field_71304_b);
            ((WorldServer)var14).func_72954_a(new WorldManager(this, (WorldServer)var14));
            if(!this.func_71264_H()) {
               ((WorldServer)var14).func_72912_H().func_76060_a(this.func_71265_f());
            }
         ...
         this.func_71203_ab().func_72364_a(new WorldServer[]{(WorldServer)var8});
      } else {
         this.field_71305_c = new WorldServer[3];
         this.field_71312_k = new long[this.field_71305_c.length][100];

         for(int var15 = 0; var15 < this.field_71305_c.length; ++var15) {
            byte var16 = 0;
            if(var15 == 1) {
               var16 = -1;
            }
            ...
            if(var15 == 0) {
               if(this.func_71242_L()) {
                  this.field_71305_c[var15] = new DemoWorldServer(this, var7, p_71247_2_, var16, this.field_71304_b);
               } else {
                  this.field_71305_c[var15] = new WorldServerOF(this, var7, p_71247_2_, var16, this.field_71350_m, this.field_71304_b);
               }
            } else {
               this.field_71305_c[var15] = new WorldServerMulti(this, var7, p_71247_2_, var16, this.field_71350_m, this.field_71305_c[0], this.field_71304_b);
            }

            this.field_71305_c[var15].func_72954_a(new WorldManager(this, this.field_71305_c[var15]));
   ...
   protected boolean func_71197_b() throws IOException {
      field_71306_a.info("Starting integrated minecraft server version 1.4.6");
