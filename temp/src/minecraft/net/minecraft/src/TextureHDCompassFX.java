...
public class TextureHDCompassFX extends TextureFX implements TextureHDFX {
   ...
   private void setup() {
      ...
      try {
         ...
         this.baseImageData = new byte[this.field_76852_a.length];
   ...
   public void func_76846_a() {
      ...
      System.arraycopy(this.baseImageData, 0, this.field_76852_a, 0, this.field_76852_a.length);
      double var8 = 0.0D;
      if(this.mc.field_71441_e != null && this.mc.field_71439_g != null) {
         ChunkCoordinates var10 = this.mc.field_71441_e.func_72861_E();
         double var11 = (double)var10.field_71574_a - this.mc.field_71439_g.field_70165_t;
         double var13 = (double)var10.field_71573_c - this.mc.field_71439_g.field_70161_v;
         var8 = (double)(this.mc.field_71439_g.field_70177_z - 90.0F) * 3.141592653589793D / 180.0D - Math.atan2(var13, var11);
         if(!this.mc.field_71441_e.field_73011_w.func_76569_d()) {
            var8 = Math.random() * 3.1415927410125732D * 2.0D;
         }
      }

      double var27;
      for(var27 = var8 - this.showAngle; var27 < -3.141592653589793D; var27 += 6.283185307179586D) {
         ;
      }

      while(var27 >= 3.141592653589793D) {
         var27 -= 6.283185307179586D;
      }
      ...
      for(var16 = -4; var16 <= 4; ++var16) {
         ...
         var24 = var19 * 4;
         this.field_76852_a[var24 + 0] = (byte)var20;
         this.field_76852_a[var24 + 1] = (byte)var21;
         this.field_76852_a[var24 + 2] = (byte)var22;
         this.field_76852_a[var24 + 3] = (byte)var23;
      }
