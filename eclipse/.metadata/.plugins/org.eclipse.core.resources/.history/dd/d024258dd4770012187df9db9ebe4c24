        ...
        if (this.worldObj != null)
        {
            if (this.needsUpdate)
            {
                ...
                if (Reflector.hasClass(3))
                {
                    ...
                    Reflector.callVoid(var26, 30, Reflector.NO_PARAMS);
                                ...
                                for (int var19 = var24; var19 < var4; ++var19)
                                {
                                    ...
                                    if (var20 > 0)
                                    {
                                        ...
                                        if (var21 != null)
                                        {
                                            ...
                                            if (var12)
                                            {
                                                var23 = Reflector.callBoolean(var21, 54, new Object[] {Integer.valueOf(var13)});
                                            }
                                            ...
                                            if (var23)
                                            {
                                                if (var12)
                                                {
                                                    Reflector.callVoid(15, new Object[] {var21, var10});
                                                }
                                                ...
                                                if (var12)
                                                {
                                                    Reflector.callVoid(16, new Object[] {var21, var10});
                                                }
                                            }
                                        }
                                    }
